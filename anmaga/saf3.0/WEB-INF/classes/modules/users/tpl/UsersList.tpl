...
<table class='tableTdBorders' cellpadding='5' cellspacing='0' width='100%'>
	...
	|-if "usersEdit"|security_has_access && $licensesLeft gt 0-|
	<tr>
	...
	<tr class="thFillTitle">
		<th width="15%" nowrap >##162,Identificación de Usuario##</th>
	...
	|-if $user->getUsername() neq 'system'-|<tr>
		...
		<td>|-$user->getLevel()-|</td>
		<td nowrap>|-if "usersEdit"|security_has_access-|<a href='Main.php?do=usersEdit&id=|-$user->getId()-||-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|' title="##114,Editar##"><img src="images/clear.png" class="icon iconEdit"></a>|-/if-|
|-if "usersDoDelete"|security_has_access-||-if $loginUser->getUsername() eq $user->getUsername()-|
...
|-/if-||-/if-|
|-if "usersPasswordResetX"|security_has_access-||-if ($loginUser->getUsername() neq $user->getUsername()) && ($user->getMailAddress() ne '')-|<form method="post">
...
|-/if-||-/if-|
	...
	|-else-|
	<tr>
		<td class='buttonCell' colspan="6"><input type='submit' value='##173,Nuevo Usuario##' class='button' onClick="return alert('Todas las licencias se encuentran en uso. Si desea dar de alta un nuevo usuario debe eliminar alguno de los existentes.');"/></td>
	</tr>
	|-/if-|
