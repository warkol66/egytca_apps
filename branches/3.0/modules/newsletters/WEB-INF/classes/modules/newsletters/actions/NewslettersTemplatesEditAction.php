...
class NewslettersTemplatesEditAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function NewslettersTemplatesEditAction() {
		;
	}
	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
		...
		$articles = $newsArticlePeer->getLastArticles(30);
		$smarty->assign('articles',$articles);

    if ( !empty($_GET["id"]) ) {
			//voy a editar un newslettertemplate

			$newslettertemplate = NewsletterTemplatePeer::get($_GET["id"]);
			...
			//voy a crear un newslettertemplate nuevo
