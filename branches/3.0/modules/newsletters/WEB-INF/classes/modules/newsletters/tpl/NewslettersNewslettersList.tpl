...
<div id="div_newsletters">
	...
	<table width="100%" cellpadding="0" cellspacing="0" class="tableTdBorders" id="tabla-newsletters">
		...
		<col width="5%">
			<thead>
			<tr>
				<th colspan="3" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=newslettersNewslettersEdit" class="addLink">Agregar Newsletter</a></div></th>
			</tr>
			<tr>
				<th>Asunto</th>
			...
			<tr>
				...
				<td nowrap="nowrap">
					<form action="Main.php" method="get">
						<input type="hidden" name="do" value="newslettersNewslettersView" />
					...
					<form action="Main.php" method="get">
						<input type="hidden" name="do" value="newslettersNewslettersEdit" />
						<input type="hidden" name="id" value="|-$newsletter->getid()-|" />
						<input type="submit" name="submit_go_edit_newsletter" value="Editar" class="buttonImageEdit" />
					</form>
					<form action="Main.php" method="post">
						<input type="hidden" name="do" value="newslettersNewslettersDoDelete" />
						<input type="hidden" name="id" value="|-$newsletter->getid()-|" />
