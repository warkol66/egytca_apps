...
class ProjectPeer extends BaseProjectPeer {
 ...
 /**
	...
	private function getSearchCriteria(){
		...
		if (!empty($this->searchDelayed)) {
			...
			$criterionFinished = $criteria->getNewCriterion(ProjectPeer::GOALEXPIRATIONDATE, date('Y-m-d') . " 00:00:00", Criteria::LESS_EQUAL);
 ...
 /**
	* Obtiene todos los projects segï¿½n las dependencias a graficar.
	*
