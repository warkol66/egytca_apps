		...
		|-foreach from=$projects item=project name=for_projects-|
			<tr>
				...
				<td width="2%"><form>
					...
					<input type="button" name="send" onClick="javascript:tableroNavigationShowGantt(this.form)" value="Ver Gráfico Gantt" class="buttonImageViewGantt2" title="Ver gráfico Gantt"/>
				</form>		</td>
