...
<div id="div_Activities"> 
	...
	<table id="tabla-Activities" class='tableTdBorders' cellpadding='5' cellspacing='0' width='100%'> 
		...
		<tr>
			...
			<tr>
				 <th colspan="7" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=projectsActivitiesEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addNew">Agregar Actividad</a></div></th>
			</tr>
	...
	|-else-|
		...
		|-/if-|
			<tr>
				 <th colspan="7" class="thFillTitle">|-if $activities|@count gt 5-|<div class="rightLink"><a href="Main.php?do=projectsActivitiesEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addNew">Agregar Actividad</a></div>|-/if-|</th>
			</tr>
		|-/if-|
		</tbody> 
		 </table> 
