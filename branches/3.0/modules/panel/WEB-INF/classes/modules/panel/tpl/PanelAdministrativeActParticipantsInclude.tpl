    ...
    <li id="partyListItem|-$party->getId()-|">
      <form  method="post"> 
        ...
        <input type="hidden" name="partyId"  value="|-$party->getId()-|" /> 
				<input type="button" value="Eliminar" title="Eliminar" onClick="if (confirm('¿Seguro que desea eliminar al participante del acto administrativo?')){deleteParticipantToAdminAct(this.form)}; return false" class="icon iconDelete" /></form> 
