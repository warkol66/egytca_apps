...
class ObjectivesNavAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function ObjectivesNavAction() {
		;
	}
	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
  	...
  	$smarty->assign("module",$module);
		...
		$tableroObjectivePeer = new ObjectivePeer();
		$tableroObjectivePeer->setStrategicObjectiveId($_GET["strategicObjectiveId"]);
		$strategicObjective = StrategicObjectivePeer::get($_GET["strategicObjectiveId"]);
