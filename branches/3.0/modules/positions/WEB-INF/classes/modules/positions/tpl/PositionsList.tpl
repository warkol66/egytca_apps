        ...
        <option value="|-$typeKey-|" |-if $typeKey eq $filters.type-|selected="selected" |-/if-|>|-$type-|</option> 
			...
			<tr>
				 <th colspan="5" class="thFillTitle">
				 	<div class="rightLink"><a href="Main.php?do=positionsEdit" class="addNew">Agregar Posición</a></div>
...
<!--				|-if ($configModule->get("positions","useFemale") eq true) -|<th width="10%">Nombre del cargo en femenino</th>|-/if-|	-->
		...
		|-else-|
			...
			<tr>
				...
				<td>|-assign var=tenure value=$position->getActiveTenure()-||-if $tenure->getObject() != NULL-||-$tenure->getOwnerName()-| &#8212;  |-assign var=tenureObject value=$tenure->getObject()-||-$tenureObject->getName()-| |-$tenureObject->getSurname()-||-/if-|</td>
        <!--				|-if ($configModule->get("positions","useFemale") eq true) -|<td>|-$position->getOwnerNameFemale()-|</td>|-/if-|	-->
				<td nowrap>
					<form action="Main.php" method="get" style="display:inline;">
						...
						<input type="submit" name="submit_go_edit_position" value="Editar" class="iconEdit" />
					</form>
					<form action="Main.php" method="post" style="display:inline;">
						...
						<input type="hidden" name="id" value="|-$position->getid()-|" />
						<input type="submit" name="submit_go_delete_position" value="Borrar" onclick="return confirm('Seguro que desea eliminar la posición?')" class="iconDelete" />
					</form>
				</td>
			</tr>
			|-/foreach-|						
		...
		|-/if-|
			<tr>
				 <th colspan="5" class="thFillTitle">|-if $positions|@count gt 5-|<div class="rightLink"><a href="Main.php?do=positionsEdit" class="addNew">Agregar Posición</a></div>|-/if-|</th>
			</tr>
		|-/if-|
		</tbody>
	</table>
...
<ul>
|-*include file="PositionsIncludeChildren.tpl" node=$root*-|
</ul>
