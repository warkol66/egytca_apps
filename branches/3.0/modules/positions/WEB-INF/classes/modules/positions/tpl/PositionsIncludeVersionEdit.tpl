<form name="form_edit_position_version" id="form_edit_position_version" action="Main.php" method="post">
	<fieldset title="Formulario de edición de versiones de organigramas">
		...
		<p>
			<label for="positionVersionData[dateFrom]">Fecha desde la cual es válido el organigrama</label>
		...
		<p>
			<label for="positionVersionData[dateTo]">Fecha hasta la cual es válido el organigrama</label>
		...
		<p>
			<label for="positionVersionData[description]">Información sobre el organigrama</label>
