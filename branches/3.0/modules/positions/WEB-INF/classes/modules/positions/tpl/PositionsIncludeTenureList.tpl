...
<legend>Funcionarios a Cargo</legend>
	<table border="0" cellpadding="5" cellspacing="0"  class='tableTdBorders' id="tabla-positions">
		<thead>
			<tr>
				 <th colspan="4" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=positionsEdit&id=|-$position->getId()-|&addTenure=1" class="addNew">Agregar Funcionario a Cargo</a></div></th>
			</tr>
			...
			<tr>
				...
				<td nowrap>
					<form action="Main.php" method="get" style="display:inline;">
						...
						<input type="submit" name="submit_go_edit_position" value="Editar" class="buttonImageEdit" />
					</form>
					<form action="Main.php" method="post" style="display:inline;">
						...
						<input type="submit" name="submit_go_delete_position" value="Borrar" onclick="return confirm('Seguro que desea eliminar el cargo?')" class="buttonImageDelete" />
					</form>
				</td>
			</tr>
		|-/foreach-|
		...
		|-/if-|
			<tr>
				 <th colspan="5" class="thFillTitle">|-if $positionTenures|@count gt 5-|<div class="rightLink"><a href="Main.php?do=positionsEdit&id=|-$position->getId()-|&addTenure=1" class="addNew">Agregar Funcionario a Cargo</a></div>|-/if-|</th>
			</tr>
		</tbody>
	</table>
</fieldset>