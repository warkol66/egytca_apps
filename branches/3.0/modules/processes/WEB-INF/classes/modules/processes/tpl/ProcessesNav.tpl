		...
		|-foreach from=$processes item=process name=for_processes-|
			<tr>
				...
				<td width="2%" class="line1"><form>
					...
					<input type="button" name="send" onClick="javascript:tableroNavigationShowGantt(this.form)" value="Ver Gráfico Gantt" class="buttonImageViewGantt" title="Ver gráfico Gantt"/>
				</form>		</td>
