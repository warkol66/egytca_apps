  ...
  <ul id="communeList">
    ...
    <li id="communeListItem|-$commune->getId()-|"> |-$commune->getName()-|
      <form  method="post"> 
        ...
        <input type="button" value="Eliminar" onClick="javascript:tableroDeleteCommuneFromProcess(this.form)" class="buttonImageDelete" /> 
      </form> 
    </li> 
    |-/foreach-|
  </ul> 
  ...
  <ul id="regionList">
    ...
    <li id="regionListItem|-$region->getId()-|">|-$region->getName()-|
      <form  method="post"> 
        ...
        <input type="button" value="Eliminar" onClick="javascript:tableroDeleteRegionFromProcess(this.form)" class="buttonImageDelete" /> 
      </form> 
    </li> 
    |-/foreach-|
  </ul> 
