...
abstract class BaseModuleDependencyPeer
{
     ...
     * e.g. ModuleDependencyPeer::$fieldNames[ModuleDependencyPeer::TYPE_PHPNAME][0] = 'Id'
     */
     ...
     *
     * first dimension keys are the type constants
     * e.g. ModuleDependencyPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    ...
    {
        $toNames = ModuleDependencyPeer::getFieldNames($toType);
        $key = isset(ModuleDependencyPeer::$fieldKeys[$fromType][$name]) ? ModuleDependencyPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ModuleDependencyPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ModuleDependencyPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ModuleDependencyPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ModuleDependencyPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ModuleDependencyPeer::DATABASE_NAME);
     ...
     *
     * @param      ModuleDependency $obj A ModuleDependency object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            ModuleDependencyPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(ModuleDependencyPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ModuleDependencyPeer::$instances[$key])) {
                return ModuleDependencyPeer::$instances[$key];
            }
        }
    ...
    {
        ModuleDependencyPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(ModuleDependencyPeer::DATABASE_NAME)->getTable(ModuleDependencyPeer::TABLE_NAME);
    }
    ...
    {
        return ModuleDependencyPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a ModuleDependency or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a ModuleDependency or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(ModuleDependencyPeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the modules_dependency table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a ModuleDependency or Criteria object OR a primary key value.
     *
