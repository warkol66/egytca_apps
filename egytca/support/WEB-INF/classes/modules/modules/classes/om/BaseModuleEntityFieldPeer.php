...
abstract class BaseModuleEntityFieldPeer
{
     ...
     * e.g. ModuleEntityFieldPeer::$fieldNames[ModuleEntityFieldPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ModuleEntityFieldPeer::UNIQUENAME, ModuleEntityFieldPeer::ENTITYNAME, ModuleEntityFieldPeer::NAME, ModuleEntityFieldPeer::DESCRIPTION, ModuleEntityFieldPeer::ISREQUIRED, ModuleEntityFieldPeer::DEFAULTVALUE, ModuleEntityFieldPeer::ISPRIMARYKEY, ModuleEntityFieldPeer::ISAUTOINCREMENT, ModuleEntityFieldPeer::ORDER, ModuleEntityFieldPeer::TYPE, ModuleEntityFieldPeer::UNIQUE, ModuleEntityFieldPeer::SIZE, ModuleEntityFieldPeer::AGGREGATEEXPRESSION, ModuleEntityFieldPeer::LABEL, ModuleEntityFieldPeer::FORMFIELDTYPE, ModuleEntityFieldPeer::FORMFIELDSIZE, ModuleEntityFieldPeer::FORMFIELDLINES, ModuleEntityFieldPeer::FORMFIELDUSECALENDAR, ModuleEntityFieldPeer::FOREIGNKEYTABLE, ModuleEntityFieldPeer::FOREIGNKEYREMOTE, ModuleEntityFieldPeer::ONDELETE, ModuleEntityFieldPeer::AUTOMATIC, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. ModuleEntityFieldPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ModuleEntityFieldPeer::UNIQUENAME => 0, ModuleEntityFieldPeer::ENTITYNAME => 1, ModuleEntityFieldPeer::NAME => 2, ModuleEntityFieldPeer::DESCRIPTION => 3, ModuleEntityFieldPeer::ISREQUIRED => 4, ModuleEntityFieldPeer::DEFAULTVALUE => 5, ModuleEntityFieldPeer::ISPRIMARYKEY => 6, ModuleEntityFieldPeer::ISAUTOINCREMENT => 7, ModuleEntityFieldPeer::ORDER => 8, ModuleEntityFieldPeer::TYPE => 9, ModuleEntityFieldPeer::UNIQUE => 10, ModuleEntityFieldPeer::SIZE => 11, ModuleEntityFieldPeer::AGGREGATEEXPRESSION => 12, ModuleEntityFieldPeer::LABEL => 13, ModuleEntityFieldPeer::FORMFIELDTYPE => 14, ModuleEntityFieldPeer::FORMFIELDSIZE => 15, ModuleEntityFieldPeer::FORMFIELDLINES => 16, ModuleEntityFieldPeer::FORMFIELDUSECALENDAR => 17, ModuleEntityFieldPeer::FOREIGNKEYTABLE => 18, ModuleEntityFieldPeer::FOREIGNKEYREMOTE => 19, ModuleEntityFieldPeer::ONDELETE => 20, ModuleEntityFieldPeer::AUTOMATIC => 21, ),
    ...
    {
        $toNames = ModuleEntityFieldPeer::getFieldNames($toType);
        $key = isset(ModuleEntityFieldPeer::$fieldKeys[$fromType][$name]) ? ModuleEntityFieldPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ModuleEntityFieldPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ModuleEntityFieldPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ModuleEntityFieldPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ModuleEntityFieldPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ModuleEntityFieldPeer::DATABASE_NAME);
     ...
     *
     * @param      ModuleEntityField $obj A ModuleEntityField object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            ModuleEntityFieldPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(ModuleEntityFieldPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ModuleEntityFieldPeer::$instances[$key])) {
                return ModuleEntityFieldPeer::$instances[$key];
            }
        }
    ...
    {
        ModuleEntityFieldPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(ModuleEntityFieldPeer::DATABASE_NAME)->getTable(ModuleEntityFieldPeer::TABLE_NAME);
    }
    ...
    {
        return ModuleEntityFieldPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a ModuleEntityField or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a ModuleEntityField or Criteria object.
     *
    ...
    /**
     * Deletes all rows from the modules_entityField table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a ModuleEntityField or Criteria object OR a primary key value.
     *
