...
/**
 * Base static class for performing query and update operations on the 'resources_resource' table.
 *
 * Recursos
 *
...
abstract class BaseResourcePeer
{
    ...
    const TABLE_NAME = 'resources_resource';
    ...
    const ID = 'resources_resource.ID';

    /** the column name for the TITLE field */
    const TITLE = 'resources_resource.TITLE';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'resources_resource.DESCRIPTION';

    /** the column name for the PATH field */
    const PATH = 'resources_resource.PATH';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Description', 'Path', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'description', 'path', ),
        BasePeer::TYPE_COLNAME => array (ResourcePeer::ID, ResourcePeer::TITLE, ResourcePeer::DESCRIPTION, ResourcePeer::PATH, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'DESCRIPTION', 'PATH', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'description', 'path', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Description' => 2, 'Path' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'description' => 2, 'path' => 3, ),
        BasePeer::TYPE_COLNAME => array (ResourcePeer::ID => 0, ResourcePeer::TITLE => 1, ResourcePeer::DESCRIPTION => 2, ResourcePeer::PATH => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'DESCRIPTION' => 2, 'PATH' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'description' => 2, 'path' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ResourcePeer::TITLE);
            $criteria->addSelectColumn(ResourcePeer::DESCRIPTION);
            $criteria->addSelectColumn(ResourcePeer::PATH);
        } else {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to resources_resource
    ...
    /**
     * Deletes all rows from the resources_resource table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
