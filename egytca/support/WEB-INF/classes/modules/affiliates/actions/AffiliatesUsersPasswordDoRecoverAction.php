<?php
/**
 * AffiliatesUsersPasswordDoRecoverAction
 *
 * @package affiliates
 */

class AffiliatesUsersPasswordDoRecoverAction extends BaseAction {

	function AffiliatesUsersPasswordDoRecoverAction() {
		;
	}
	...
	function execute($mapping, $form, &$request, &$response) {
		...
		$user = AffiliateUserPeer::getByRecoveryHash($_GET["recoveryHash"]);
