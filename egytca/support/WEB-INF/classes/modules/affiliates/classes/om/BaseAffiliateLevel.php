...
abstract class BaseAffiliateLevel extends BaseObject implements Persistent
{
    ...
    protected $collAffiliateUsersPartial;
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AffiliateLevelQuery::create()
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->affiliateUsersScheduledForDeletion !== null) {
                if (!$this->affiliateUsersScheduledForDeletion->isEmpty()) {
                    foreach ($this->affiliateUsersScheduledForDeletion as $affiliateUser) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AffiliateLevelPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(AffiliateLevelPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`NAME`';
        }
        if ($this->isColumnModified(AffiliateLevelPeer::BITLEVEL)) {
            $modifiedColumns[':p' . $index++]  = '`BITLEVEL`';
        }

        $sql = sprintf(
            'INSERT INTO `affiliates_level` (%s) VALUES (%s)',
    ...
    /**
     * reset is the collAffiliateUsers collection loaded partially
     *
     * @return void
     */
    public function resetPartialAffiliateUsers($v = true)
    {
        $this->collAffiliateUsersPartial = $v;
    }
    ...
    {
        $partial = $this->collAffiliateUsersPartial && !$this->isNew();
        if (null === $this->collAffiliateUsers || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collAffiliateUsers) {
                ...
                $collAffiliateUsers = AffiliateUserQuery::create(null, $criteria)
                    ...
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collAffiliateUsersPartial && count($collAffiliateUsers)) {
                      $this->initAffiliateUsers(false);

                      foreach($collAffiliateUsers as $obj) {
                        if (false == $this->collAffiliateUsers->contains($obj)) {
                          $this->collAffiliateUsers->append($obj);
                        }
                      }

                      $this->collAffiliateUsersPartial = true;
                    }

                    return $collAffiliateUsers;
                }

                if($partial && $this->collAffiliateUsers) {
                    foreach($this->collAffiliateUsers as $obj) {
                        if($obj->isNew()) {
                            $collAffiliateUsers[] = $obj;
                        }
                    }
                }

                $this->collAffiliateUsers = $collAffiliateUsers;
                $this->collAffiliateUsersPartial = false;
            }
        }
    ...
    /**
     * Sets a collection of AffiliateUser objects related by a one-to-many relationship
    ...
    {
        $this->affiliateUsersScheduledForDeletion = $this->getAffiliateUsers(new Criteria(), $con)->diff($affiliateUsers);

        foreach ($this->affiliateUsersScheduledForDeletion as $affiliateUserRemoved) {
            $affiliateUserRemoved->setAffiliateLevel(null);
        }

        $this->collAffiliateUsers = null;
        foreach ($affiliateUsers as $affiliateUser) {
            $this->addAffiliateUser($affiliateUser);
        }
    ...
    public function countAffiliateUsers(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collAffiliateUsers || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collAffiliateUsers) {
                ...
                if($partial && !$criteria) {
                    return count($this->getAffiliateUsers());
                }
    ...
    protected function doAddAffiliateUser($affiliateUser)
    {
        ...
        $affiliateUser->setAffiliateLevel($this);
    }

    /**
     * @param	AffiliateUser $affiliateUser The affiliateUser object to remove.
     */
    public function removeAffiliateUser($affiliateUser)
    {
        if ($this->getAffiliateUsers()->contains($affiliateUser)) {
            ...
            $affiliateUser->setAffiliateLevel(null);
        }
    }
