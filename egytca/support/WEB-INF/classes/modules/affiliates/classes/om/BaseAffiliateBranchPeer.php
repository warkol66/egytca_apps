...
abstract class BaseAffiliateBranchPeer
{
     ...
     * e.g. AffiliateBranchPeer::$fieldNames[AffiliateBranchPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (AffiliateBranchPeer::ID, AffiliateBranchPeer::AFFILIATEID, AffiliateBranchPeer::NUMBER, AffiliateBranchPeer::CODE, AffiliateBranchPeer::NAME, AffiliateBranchPeer::PHONE, AffiliateBranchPeer::CONTACT, AffiliateBranchPeer::CONTACTEMAIL, AffiliateBranchPeer::MEMO, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. AffiliateBranchPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (AffiliateBranchPeer::ID => 0, AffiliateBranchPeer::AFFILIATEID => 1, AffiliateBranchPeer::NUMBER => 2, AffiliateBranchPeer::CODE => 3, AffiliateBranchPeer::NAME => 4, AffiliateBranchPeer::PHONE => 5, AffiliateBranchPeer::CONTACT => 6, AffiliateBranchPeer::CONTACTEMAIL => 7, AffiliateBranchPeer::MEMO => 8, ),
    ...
    {
        $toNames = AffiliateBranchPeer::getFieldNames($toType);
        $key = isset(AffiliateBranchPeer::$fieldKeys[$fromType][$name]) ? AffiliateBranchPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(AffiliateBranchPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, AffiliateBranchPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return AffiliateBranchPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AffiliateBranchPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AffiliateBranchPeer::DATABASE_NAME);
     ...
     *
     * @param      AffiliateBranch $obj A AffiliateBranch object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            AffiliateBranchPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(AffiliateBranchPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(AffiliateBranchPeer::$instances[$key])) {
                return AffiliateBranchPeer::$instances[$key];
            }
        }
    ...
    {
        AffiliateBranchPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(AffiliateBranchPeer::DATABASE_NAME)->getTable(AffiliateBranchPeer::TABLE_NAME);
    }
    ...
    {
        return AffiliateBranchPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a AffiliateBranch or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a AffiliateBranch or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(AffiliateBranchPeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the affiliates_branch table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a AffiliateBranch or Criteria object OR a primary key value.
     *
