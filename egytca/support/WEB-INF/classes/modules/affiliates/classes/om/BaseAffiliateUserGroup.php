...
abstract class BaseAffiliateUserGroup extends BaseObject implements Persistent
{
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AffiliateUserGroupQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AffiliateUserGroupPeer::USERID)) {
            $modifiedColumns[':p' . $index++]  = '`USERID`';
        }
        if ($this->isColumnModified(AffiliateUserGroupPeer::GROUPID)) {
            $modifiedColumns[':p' . $index++]  = '`GROUPID`';
        }

        $sql = sprintf(
            'INSERT INTO `affiliates_userGroup` (%s) VALUES (%s)',
