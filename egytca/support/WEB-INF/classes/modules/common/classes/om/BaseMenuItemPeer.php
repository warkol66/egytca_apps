...
abstract class BaseMenuItemPeer
{
     ...
     * e.g. MenuItemPeer::$fieldNames[MenuItemPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (MenuItemPeer::ID, MenuItemPeer::ACTION, MenuItemPeer::URL, MenuItemPeer::ORDER, MenuItemPeer::PARENTID, MenuItemPeer::NEWWINDOW, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. MenuItemPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (MenuItemPeer::ID => 0, MenuItemPeer::ACTION => 1, MenuItemPeer::URL => 2, MenuItemPeer::ORDER => 3, MenuItemPeer::PARENTID => 4, MenuItemPeer::NEWWINDOW => 5, ),
    ...
    {
        $toNames = MenuItemPeer::getFieldNames($toType);
        $key = isset(MenuItemPeer::$fieldKeys[$fromType][$name]) ? MenuItemPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(MenuItemPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, MenuItemPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return MenuItemPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(MenuItemPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(MenuItemPeer::DATABASE_NAME);
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            MenuItemPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(MenuItemPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(MenuItemPeer::$instances[$key])) {
                return MenuItemPeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(MenuItemPeer::DATABASE_NAME)->getTable(MenuItemPeer::TABLE_NAME);
    }
    ...
    /**
     * Performs an UPDATE on the database, given a MenuItem or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(MenuItemPeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the common_menuItem table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
