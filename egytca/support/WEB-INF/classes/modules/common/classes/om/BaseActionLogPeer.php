...
abstract class BaseActionLogPeer
{
     ...
     * e.g. ActionLogPeer::$fieldNames[ActionLogPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Userobjecttype', 'Userobjectid', 'Datetime', 'Action', 'Message', 'Forward', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userobjecttype', 'userobjectid', 'datetime', 'action', 'message', 'forward', ),
        BasePeer::TYPE_COLNAME => array (ActionLogPeer::ID, ActionLogPeer::USEROBJECTTYPE, ActionLogPeer::USEROBJECTID, ActionLogPeer::DATETIME, ActionLogPeer::ACTION, ActionLogPeer::MESSAGE, ActionLogPeer::FORWARD, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USEROBJECTTYPE', 'USEROBJECTID', 'DATETIME', 'ACTION', 'MESSAGE', 'FORWARD', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'userObjectType', 'userObjectId', 'datetime', 'action', 'message', 'forward', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. ActionLogPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Userobjecttype' => 1, 'Userobjectid' => 2, 'Datetime' => 3, 'Action' => 4, 'Message' => 5, 'Forward' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userobjecttype' => 1, 'userobjectid' => 2, 'datetime' => 3, 'action' => 4, 'message' => 5, 'forward' => 6, ),
        BasePeer::TYPE_COLNAME => array (ActionLogPeer::ID => 0, ActionLogPeer::USEROBJECTTYPE => 1, ActionLogPeer::USEROBJECTID => 2, ActionLogPeer::DATETIME => 3, ActionLogPeer::ACTION => 4, ActionLogPeer::MESSAGE => 5, ActionLogPeer::FORWARD => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USEROBJECTTYPE' => 1, 'USEROBJECTID' => 2, 'DATETIME' => 3, 'ACTION' => 4, 'MESSAGE' => 5, 'FORWARD' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'userObjectType' => 1, 'userObjectId' => 2, 'datetime' => 3, 'action' => 4, 'message' => 5, 'forward' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    {
        $toNames = ActionLogPeer::getFieldNames($toType);
        $key = isset(ActionLogPeer::$fieldKeys[$fromType][$name]) ? ActionLogPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ActionLogPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ActionLogPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ActionLogPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ActionLogPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ActionLogPeer::DATABASE_NAME);
     ...
     *
     * @param      ActionLog $obj A ActionLog object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            ActionLogPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(ActionLogPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ActionLogPeer::$instances[$key])) {
                return ActionLogPeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(ActionLogPeer::DATABASE_NAME)->getTable(ActionLogPeer::TABLE_NAME);
    }
    ...
    {
        return ActionLogPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a ActionLog or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a ActionLog or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(ActionLogPeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the actionLogs_log table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a ActionLog or Criteria object OR a primary key value.
     *
