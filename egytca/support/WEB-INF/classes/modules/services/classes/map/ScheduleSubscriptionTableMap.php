...
/**
 * This class defines the structure of the 'services_scheduleSubscription' table.
 *
 *
 *
...
class ScheduleSubscriptionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'services.classes.map.ScheduleSubscriptionTableMap';
    ...
    {
        // attributes
        $this->setName('services_scheduleSubscription');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('ScheduleSubscriptionUser', 'ScheduleSubscriptionUser', RelationMap::ONE_TO_MANY, array('id' => 'scheduleSubscriptionId', ), 'CASCADE', null, 'ScheduleSubscriptionUsers');
