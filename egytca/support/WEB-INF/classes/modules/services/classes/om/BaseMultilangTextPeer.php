...
abstract class BaseMultilangTextPeer
{
     ...
     * e.g. MultilangTextPeer::$fieldNames[MultilangTextPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (MultilangTextPeer::ID, MultilangTextPeer::MODULENAME, MultilangTextPeer::LANGUAGECODE, MultilangTextPeer::TEXT, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. MultilangTextPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (MultilangTextPeer::ID => 0, MultilangTextPeer::MODULENAME => 1, MultilangTextPeer::LANGUAGECODE => 2, MultilangTextPeer::TEXT => 3, ),
    ...
    {
        $toNames = MultilangTextPeer::getFieldNames($toType);
        $key = isset(MultilangTextPeer::$fieldKeys[$fromType][$name]) ? MultilangTextPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(MultilangTextPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, MultilangTextPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return MultilangTextPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(MultilangTextPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(MultilangTextPeer::DATABASE_NAME);
     ...
     *
     * @param      MultilangText $obj A MultilangText object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            MultilangTextPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(MultilangTextPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(MultilangTextPeer::$instances[$key])) {
                return MultilangTextPeer::$instances[$key];
            }
        }
    ...
    {
        MultilangTextPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(MultilangTextPeer::DATABASE_NAME)->getTable(MultilangTextPeer::TABLE_NAME);
    }
    ...
    {
        return MultilangTextPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a MultilangText or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a MultilangText or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(MultilangTextPeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the multilang_text table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a MultilangText or Criteria object OR a primary key value.
     *
