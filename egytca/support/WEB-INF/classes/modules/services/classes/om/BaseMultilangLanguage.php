...
abstract class BaseMultilangLanguage extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = MultilangLanguagePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MultilangLanguageQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MultilangLanguagePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(MultilangLanguagePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`NAME`';
        }
        if ($this->isColumnModified(MultilangLanguagePeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`CODE`';
        }
        if ($this->isColumnModified(MultilangLanguagePeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`LOCALE`';
        }

        $sql = sprintf(
            'INSERT INTO `multilang_language` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['MultilangLanguage'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MultilangLanguage'][$this->getPrimaryKey()] = true;
    ...
    public function setMultilangTexts(PropelCollection $multilangTexts, PropelPDO $con = null)
    {
        ...
        foreach ($this->multilangTextsScheduledForDeletion as $multilangTextRemoved) {
            $multilangTextRemoved->setMultilangLanguage(null);
        }
    ...
    protected function doAddMultilangText($multilangText)
    {
        ...
        $multilangText->setMultilangLanguage($this);
    }
    ...
    public function removeMultilangText($multilangText)
    {
        if ($this->getMultilangTexts()->contains($multilangText)) {
            ...
            $multilangText->setMultilangLanguage(null);
        }
    }
