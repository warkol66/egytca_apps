...
<div id="div_text">
  <form name="form_edit_text" id="form_edit_text" action="Main.php" method="post">
    ...
    <p> |-if $action eq "edit"-|
      ...
      <input type="hidden" name="do" id="do" value="servicesMultilangTextsDoEdit" />
      ...
      <input type="button" id="return" name="return" title="Regresar" value="Regresar" onclick="location.href='Main.php?do=servicesMultilangTextsList&moduleName=|-$moduleName-|&currentPage=|-$currentPage-|'"/>
    </p>
    </fieldset>
  </form>
</div>
