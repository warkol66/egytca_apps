...
<div id="div_schedulesSubscriptions"> 
		...
		<tr>
			<td colspan="7" class="tdSearch"><a href="javascript:void(null);" onClick='switch_vis("divSearch");' class="tdTitSearch">Busqueda de suscripciones a agendas</a>
				<div id="divSearch" style="display:|-if $filters|@count gt 0-|block|-else-|none|-/if-|;"><form action='Main.php' method='get' style="display:inline;">
					<input type="hidden" name="do" value="servicesSchedulesSubscriptionsList" />
			...
			<tr>
				 <th colspan="7" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=servicesSchedulesSubscriptionsEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addLink">Agregar Suscripción a Agenda</a></div></th>
			</tr>
	...
	|-else-|
		...
		<tr> 
			...
			<td nowrap> 
				<form action="Main.php" method="get" style="display:inline;"> 
					<input type="hidden" name="do" value="servicesSchedulesSubscriptionsEdit" /> 
				...
				<form action="Main.php" method="post" style="display:inline;"> 
					<input type="hidden" name="do" value="servicesSchedulesSubscriptionsDoDelete" /> 
						|-include file="FiltersRedirectInclude.tpl" filters=$filters-|
						|-if isset($pager) && ($pager->getPage() ne 1)-| <input type="hidden" name="page" id="page" value="|-$pager->getPage()-|" />|-/if-|
					<input type="hidden" name="id" value="|-$scheduleSubscription->getid()-|" /> 
		...
		|-/if-|
			<tr>
				 <th colspan="7" class="thFillTitle">|-if $schedulesSubscriptions|@count gt 5-|<div class="rightLink"><a href="Main.php?do=servicesSchedulesSubscriptionsEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addLink">Agregar Suscripción a Agenda</a></div>|-/if-|</th>
			</tr>
		|-/if-|
		</tbody> 
		 </table> 
