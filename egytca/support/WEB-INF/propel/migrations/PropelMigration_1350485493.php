 ...
 * up to version 1350485493.
 * Generated on 2012-10-17 11:51:33 by sol
 */
class PropelMigration_1350485493
{
...
ALTER TABLE `requirements_resource` ADD CONSTRAINT `requirements_resource_FK_1`
...
ALTER TABLE `requirements_resource` DROP FOREIGN KEY `requirements_resource_FK_1`;
