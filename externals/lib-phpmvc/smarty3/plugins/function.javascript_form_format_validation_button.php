 ...
 * @return string|null
 */
function smarty_function_javascript_form_format_validation_button($params, &$smarty){
	...
	$output = "<input type=\"button\" name=\"$buttonName\" id=\"$buttonId\" value=\"$buttonValue\" title=\"$buttonTitle\" onClick=\"javascript:formatInputs('$thousands','$decimal');validationValidateFormClienSide(this.form);\" />";
