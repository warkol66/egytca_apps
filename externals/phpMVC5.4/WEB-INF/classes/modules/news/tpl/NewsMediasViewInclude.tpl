...
<div id="OuterContainer">
	<div id="Container">
		...
		<div id="LinkContainer"|-if $newsarticle->getImages()|@count eq 1-| style="display: none;"|-/if-|>
...
var photoDir = "Main.php?do=newsMediasGetImage&id=";
// Define each photo's name, height, width, and caption
var photoArray = new Array(
	// Source, Width, Height, Caption
	|-foreach from=$newsarticle->getImages() item=image name=images-|
