...
class BoardChangeStatusesAction extends BaseAction {

	function BoardChangeStatusesAction() {
		;
	}
	...
	function execute($mapping, $form, &$request, &$response) {
		...
		if (isset($_POST['status']) && isset($_POST['selected'])) {
			...
			BoardChallengeQuery::create()->filterById($_POST['selected'], Criteria::IN)->update(array('Status' => $_POST['status']));
