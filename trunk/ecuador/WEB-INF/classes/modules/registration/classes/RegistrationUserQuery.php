...
class RegistrationUserQuery extends BaseRegistrationUserQuery {
 ...
 /**
	...
	*
	* @return array con nombres de paises
	*/
 ...
 /**
	* Aplica parametros de busqeuda de textos
	*
	* @param string $searchString texto a buscar
	* @return propelObject regresa el RegistrationUserquery con los filtros de texto sobre lso campso deseados
	*/
	public function searchString($searchString) {
		return $this->filterByUsername("%$searchString%")
					->_or()
						->filterByName("%$searchString%")
					->_or()
						->filterBySurname("%$searchString%")
					->_or()
						->filterByMailaddress("%$searchString%");
	}
