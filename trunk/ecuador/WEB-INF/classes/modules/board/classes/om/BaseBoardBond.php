...
/**
 * Base class that represents a row from the 'board_bond' table.
 *
 * Compromiso con el challenge
 *
 * @package    propel.generator.board.classes.om
 */
abstract class BaseBoardBond extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'BoardBondPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BoardBondPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = BoardBondPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = BoardBondPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BoardBond object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BoardBondPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BoardBondQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BoardBondPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BoardBondPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(BoardBondPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`NAME`';
        }

        $sql = sprintf(
            'INSERT INTO `board_bond` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BoardBondPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BoardBondPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BoardBond'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BoardBond'][$this->getPrimaryKey()] = true;
        $keys = BoardBondPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BoardBondPeer::ID)) $criteria->add(BoardBondPeer::ID, $this->id);
        if ($this->isColumnModified(BoardBondPeer::NAME)) $criteria->add(BoardBondPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(BoardBondPeer::DATABASE_NAME);
        $criteria->add(BoardBondPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of BoardBond (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BoardBond Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BoardBondPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BoardBondPeer();
        }
    ...
    {
        return (string) $this->exportTo(BoardBondPeer::DEFAULT_STRING_FORMAT);
    }
