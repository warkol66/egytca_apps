 ...
 * up to version 1350412450.
 * Generated on 2012-10-16 15:34:10 by sol
 */
class PropelMigration_1350412450
{
...
CREATE TABLE `requirements_requirement_resource`
(
    `id` INTEGER NOT NULL AUTO_INCREMENT COMMENT \'Headline Id\',
    `requirementId` INTEGER NOT NULL COMMENT \'Id del requerimiento\',
    `resourceId` INTEGER NOT NULL COMMENT \'Id del recurso\',
    PRIMARY KEY (`id`),
    INDEX `requirements_requirement_resource_FI_1` (`requirementId`),
    INDEX `requirements_requirement_resource_FI_2` (`resourceId`),
    CONSTRAINT `requirements_requirement_resource_FK_1`
        FOREIGN KEY (`requirementId`)
        REFERENCES `requirements_requirement` (`id`)
        ON DELETE CASCADE,
    CONSTRAINT `requirements_requirement_resource_FK_2`
        FOREIGN KEY (`resourceId`)
        REFERENCES `resources_resource` (`id`)
        ON DELETE CASCADE
) ENGINE=MyISAM CHARACTER SET=\'utf8\' COLLATE=\'utf8_general_ci\' COMMENT=\'Recurso de Requerimiento\';

CREATE TABLE `requirements_development_resource`
(
    `id` INTEGER NOT NULL AUTO_INCREMENT COMMENT \'Headline Id\',
    `requirementId` INTEGER NOT NULL COMMENT \'Id del requerimiento\',
    `resourceId` INTEGER NOT NULL COMMENT \'Id del recurso\',
    PRIMARY KEY (`id`),
    INDEX `requirements_development_resource_FI_1` (`requirementId`),
    INDEX `requirements_development_resource_FI_2` (`resourceId`),
    CONSTRAINT `requirements_development_resource_FK_1`
        FOREIGN KEY (`requirementId`)
        REFERENCES `requirements_development` (`id`)
        ON DELETE CASCADE,
    CONSTRAINT `requirements_development_resource_FK_2`
        FOREIGN KEY (`resourceId`)
        REFERENCES `resources_resource` (`id`)
        ON DELETE CASCADE
...
DROP TABLE IF EXISTS `requirements_requirement_resource`;

DROP TABLE IF EXISTS `requirements_development_resource`;
