 ...
 * up to version 1350485249.
 * Generated on 2012-10-17 11:47:29 by sol
 */
class PropelMigration_1350485249
{
...
CREATE TABLE `requirements_resource`
(
    ...
    PRIMARY KEY (`id`),
    INDEX `requirements_resource_FI_1` (`resourceId`),
    CONSTRAINT `requirements_resource_FK_1`
...
DROP TABLE IF EXISTS `requirements_resource`;
...
(
    ...
    INDEX `requirements_development_resource_FI_1` (`developmentId`)
) ENGINE=MyISAM;
