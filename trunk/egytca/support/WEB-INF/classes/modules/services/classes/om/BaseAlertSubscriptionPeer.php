...
/**
 * Base static class for performing query and update operations on the 'services_alertSubscription' table.
 *
...
abstract class BaseAlertSubscriptionPeer
{
    ...
    const TABLE_NAME = 'services_alertSubscription';
    ...
    const ID = 'services_alertSubscription.ID';

    /** the column name for the NAME field */
    const NAME = 'services_alertSubscription.NAME';

    /** the column name for the ENTITYNAME field */
    const ENTITYNAME = 'services_alertSubscription.ENTITYNAME';

    /** the column name for the ENTITYDATEFIELDUNIQUENAME field */
    const ENTITYDATEFIELDUNIQUENAME = 'services_alertSubscription.ENTITYDATEFIELDUNIQUENAME';

    /** the column name for the ENTITYBOOLEANFIELDUNIQUENAME field */
    const ENTITYBOOLEANFIELDUNIQUENAME = 'services_alertSubscription.ENTITYBOOLEANFIELDUNIQUENAME';

    /** the column name for the ANTICIPATIONDAYS field */
    const ANTICIPATIONDAYS = 'services_alertSubscription.ANTICIPATIONDAYS';

    /** the column name for the ENTITYNAMEFIELDUNIQUENAME field */
    const ENTITYNAMEFIELDUNIQUENAME = 'services_alertSubscription.ENTITYNAMEFIELDUNIQUENAME';

    /** the column name for the EXTRARECIPIENTS field */
    const EXTRARECIPIENTS = 'services_alertSubscription.EXTRARECIPIENTS';
     ...
     * e.g. AlertSubscriptionPeer::$fieldNames[AlertSubscriptionPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (AlertSubscriptionPeer::ID, AlertSubscriptionPeer::NAME, AlertSubscriptionPeer::ENTITYNAME, AlertSubscriptionPeer::ENTITYDATEFIELDUNIQUENAME, AlertSubscriptionPeer::ENTITYBOOLEANFIELDUNIQUENAME, AlertSubscriptionPeer::ANTICIPATIONDAYS, AlertSubscriptionPeer::ENTITYNAMEFIELDUNIQUENAME, AlertSubscriptionPeer::EXTRARECIPIENTS, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. AlertSubscriptionPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (AlertSubscriptionPeer::ID => 0, AlertSubscriptionPeer::NAME => 1, AlertSubscriptionPeer::ENTITYNAME => 2, AlertSubscriptionPeer::ENTITYDATEFIELDUNIQUENAME => 3, AlertSubscriptionPeer::ENTITYBOOLEANFIELDUNIQUENAME => 4, AlertSubscriptionPeer::ANTICIPATIONDAYS => 5, AlertSubscriptionPeer::ENTITYNAMEFIELDUNIQUENAME => 6, AlertSubscriptionPeer::EXTRARECIPIENTS => 7, ),
    ...
    {
        $toNames = AlertSubscriptionPeer::getFieldNames($toType);
        $key = isset(AlertSubscriptionPeer::$fieldKeys[$fromType][$name]) ? AlertSubscriptionPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(AlertSubscriptionPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, AlertSubscriptionPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return AlertSubscriptionPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AlertSubscriptionPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AlertSubscriptionPeer::DATABASE_NAME);
     ...
     *
     * @param      AlertSubscription $obj A AlertSubscription object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            AlertSubscriptionPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(AlertSubscriptionPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(AlertSubscriptionPeer::$instances[$key])) {
                return AlertSubscriptionPeer::$instances[$key];
            }
        }
    ...
    {
        AlertSubscriptionPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to services_alertSubscription
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = AlertSubscriptionPeer::getOMClass();
    ...
    {
        return Propel::getDatabaseMap(AlertSubscriptionPeer::DATABASE_NAME)->getTable(AlertSubscriptionPeer::TABLE_NAME);
    }
    ...
    {
        return AlertSubscriptionPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a AlertSubscription or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a AlertSubscription or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(AlertSubscriptionPeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the services_alertSubscription table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a AlertSubscription or Criteria object OR a primary key value.
     *
