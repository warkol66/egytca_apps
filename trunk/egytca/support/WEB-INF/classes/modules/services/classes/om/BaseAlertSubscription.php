...
/**
 * Base class that represents a row from the 'services_alertSubscription' table.
 *
...
abstract class BaseAlertSubscription extends BaseObject implements Persistent
{
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AlertSubscriptionPeer::ENTITYDATEFIELDUNIQUENAME)) {
            $modifiedColumns[':p' . $index++]  = '`ENTITYDATEFIELDUNIQUENAME`';
        }
        if ($this->isColumnModified(AlertSubscriptionPeer::ENTITYBOOLEANFIELDUNIQUENAME)) {
        ...
        $sql = sprintf(
            'INSERT INTO `services_alertSubscription` (%s) VALUES (%s)',
