...
|-if isset($pager) && $pager->haveToPaginate()-|
	<div id="div_paginate" style="text-align:center">
		...
		<div id="paginateLast" class="paginateText">|-assign var="lastpage" value=$pager->getLastPage()-||-if $lastpage neq $page-|<a href="#" onclick="$('page').value='|-$lastpage-|'; loadRelatedEntitiesContent('|-block name=entityType-||-/block-|', $('filters')); return false;" class="detail">Última</a>|-else-|<span class="deactivated">Última</span>|-/if-|</div>
	</div>
|-/if-|