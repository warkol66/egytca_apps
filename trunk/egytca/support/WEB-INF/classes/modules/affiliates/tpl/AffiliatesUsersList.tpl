...
<tr>
<td colspan="5" class="tdSearch"><a href="javascript:void(null);" onClick='$("divSearch").toggle();' class="tdTitSearch">Buscar usuario</a>
...
|-/if-|
	...
	|-foreach from=$affiliateUserColl item=user name=for_users-|
	<tr>
