...
/**
 * This class defines the structure of the 'requirements_development' table.
 *
 *
 *
 ...
 */
class DevelopmentTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'requirements.classes.map.DevelopmentTableMap';
    ...
    {
        // attributes
        $this->setName('requirements_development');
        $this->setPhpName('Development');
        $this->setClassname('Development');
        ...
        $this->addColumn('QUOTATION', 'Quotation', 'FLOAT', false, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Requirement', 'Requirement', RelationMap::ONE_TO_MANY, array('id' => 'developmentId', ), 'CASCADE', null, 'Requirements');
    } // buildRelations()
