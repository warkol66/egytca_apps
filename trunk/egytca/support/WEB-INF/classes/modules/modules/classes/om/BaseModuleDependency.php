...
abstract class BaseModuleDependency extends BaseObject implements Persistent
{
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ModuleDependencyQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ModuleDependencyPeer::MODULENAME)) {
            $modifiedColumns[':p' . $index++]  = '`MODULENAME`';
        }
        if ($this->isColumnModified(ModuleDependencyPeer::DEPENDENCE)) {
            $modifiedColumns[':p' . $index++]  = '`DEPENDENCE`';
        }

        $sql = sprintf(
            'INSERT INTO `modules_dependency` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`MODULENAME`':
                        ...
                        break;
                    case '`DEPENDENCE`':
                        $stmt->bindValue($identifier, $this->dependence, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        if (isset($alreadyDumpedObjects['ModuleDependency'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ModuleDependency'][serialize($this->getPrimaryKey())] = true;
    ...
    {
        return (string) $this->exportTo(ModuleDependencyPeer::DEFAULT_STRING_FORMAT);
    }
