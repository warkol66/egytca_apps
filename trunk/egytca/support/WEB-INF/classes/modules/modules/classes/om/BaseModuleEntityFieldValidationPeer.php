...
abstract class BaseModuleEntityFieldValidationPeer
{
     ...
     * e.g. ModuleEntityFieldValidationPeer::$fieldNames[ModuleEntityFieldValidationPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ModuleEntityFieldValidationPeer::ENTITYFIELDUNIQUENAME, ModuleEntityFieldValidationPeer::NAME, ModuleEntityFieldValidationPeer::VALUE, ModuleEntityFieldValidationPeer::MESSAGE, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. ModuleEntityFieldValidationPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ModuleEntityFieldValidationPeer::ENTITYFIELDUNIQUENAME => 0, ModuleEntityFieldValidationPeer::NAME => 1, ModuleEntityFieldValidationPeer::VALUE => 2, ModuleEntityFieldValidationPeer::MESSAGE => 3, ),
    ...
    {
        $toNames = ModuleEntityFieldValidationPeer::getFieldNames($toType);
        $key = isset(ModuleEntityFieldValidationPeer::$fieldKeys[$fromType][$name]) ? ModuleEntityFieldValidationPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ModuleEntityFieldValidationPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ModuleEntityFieldValidationPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ModuleEntityFieldValidationPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ModuleEntityFieldValidationPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ModuleEntityFieldValidationPeer::DATABASE_NAME);
     ...
     *
     * @param      ModuleEntityFieldValidation $obj A ModuleEntityFieldValidation object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            ModuleEntityFieldValidationPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(ModuleEntityFieldValidationPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ModuleEntityFieldValidationPeer::$instances[$key])) {
                return ModuleEntityFieldValidationPeer::$instances[$key];
            }
        }
    ...
    {
        ModuleEntityFieldValidationPeer::$instances = array();
    }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = ModuleEntityFieldValidationPeer::getOMClass();
    ...
    {
        return Propel::getDatabaseMap(ModuleEntityFieldValidationPeer::DATABASE_NAME)->getTable(ModuleEntityFieldValidationPeer::TABLE_NAME);
    }
    ...
    {
        return ModuleEntityFieldValidationPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a ModuleEntityFieldValidation or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a ModuleEntityFieldValidation or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(ModuleEntityFieldValidationPeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the modules_entityFieldValidation table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    /**
     * Performs a DELETE on the database, given a ModuleEntityFieldValidation or Criteria object OR a primary key value.
     *
