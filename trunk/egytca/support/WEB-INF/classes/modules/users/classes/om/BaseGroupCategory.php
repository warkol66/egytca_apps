...
abstract class BaseGroupCategory extends BaseObject implements Persistent
{
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GroupCategoryQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GroupCategoryPeer::GROUPID)) {
            $modifiedColumns[':p' . $index++]  = '`GROUPID`';
        }
        if ($this->isColumnModified(GroupCategoryPeer::CATEGORYID)) {
            $modifiedColumns[':p' . $index++]  = '`CATEGORYID`';
        }

        $sql = sprintf(
            'INSERT INTO `users_groupCategory` (%s) VALUES (%s)',
