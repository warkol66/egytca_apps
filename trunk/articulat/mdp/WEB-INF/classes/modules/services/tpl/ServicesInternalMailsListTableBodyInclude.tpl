...
|-if $internalMails|@count gt 5-|	<tr>
		 <th colspan="5"><div class="rightLink"><a href="Main.php?do=servicesInternalMailsEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="linkMailNew">Nuevo mensaje</a></div></th>
	</tr>|-/if-|
|-/if-|
