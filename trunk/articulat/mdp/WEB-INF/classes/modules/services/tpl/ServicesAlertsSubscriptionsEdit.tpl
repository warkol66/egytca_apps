...
function showEntityFieldSelector(entityName) {
	var myAjax = new Ajax.Updater(
				...
				'Main.php?do=servicesAlertsSubscriptionsGetEntityFields',
				{
					method: 'get',
...
<div id="div_alertSubscription">
	<p>Ingrese los datos del Suscripción a Alerta</p>
		<p><a href="#" onClick="location.href='Main.php?do=servicesAlertsSubscriptionsList|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($page)-|&page=|-$page-||-/if-|'">Volver atras</a>
		</p>
	|-if $message eq "ok"-|
	...
	<form name="form_edit_alertSubscription" id="form_edit_alertSubscription" action="Main.php" method="post">
		<fieldset title="Formulario de edición de datos de un Suscripción a Alerta">
			...
			<div id="entityFieldSelector">
				|-include file="ServicesAlertsSubscriptionsEntityFieldSelectorInclude.tpl"-|
			</div>
				|-if $action eq 'edit'-|
			...
			<p>* Para agregar información sobre destinatarios debe guardar primero la suscripción a alerta. </p>
				|-/if-|
			<p>
				<input type="hidden" name="do" id="do" value="servicesAlertsSubscriptionsDoEdit" />
				<input type="submit" id="button_edit_alertSubscription" name="button_edit_alertSubscription" title="Aceptar" value="Guardar" />
				<input type="button" id="cancel" name="cancel" title="Volver al listado" value="Volver al listado" onClick="location.href='Main.php?do=servicesAlertsSubscriptionsList|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($page)-|&page=|-$page-||-/if-|'"/>
			</p>
		</fieldset>
	</form>
</div>
...
<div id="PartyAdding"> <span id="partieMsgField"></span> 
  <form method="post"> 
	...
	<p>
      <input type="hidden" name="do" id="do" value="servicesAlertsSubscriptionsDoAddUserX" /> 
  ...
  <div id="detinataryList">
	|-include file="ServicesAlertsSubscriptionsUsersInclude.tpl"-|
  </div>	
