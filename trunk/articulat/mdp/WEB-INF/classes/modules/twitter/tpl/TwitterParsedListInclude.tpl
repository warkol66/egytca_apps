    ...
    <li id="li_|-$tweet->getId()-|">
		<div class="tweet">
			<div class="twitterButtons">
				...
				<img src="images/clear.png" class="icon iconMinus" onClick='{new Ajax.Updater("resultDiv", "Main.php?do=twitterDoEditX", { method: "post", parameters: { id: "|-$tweet->getId()-|", "params[value]": "3", parsed: true}, evalScripts: true})};$("resultDiv").innerHTML = "<span class=\"inProgress\">guardando tweet...</span>";' value="Valorar negativo" />
