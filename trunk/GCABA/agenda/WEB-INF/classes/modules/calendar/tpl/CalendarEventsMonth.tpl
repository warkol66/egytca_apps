...
##calendar,9,Agenda mensual de## |-$monthDisplayed|date_format:"%B %Y"|ucfirst-|&nbsp;&nbsp;<a href="Main.php?do=calendarEventsMonth&month=|-$previousMonth-|&year=|-$previousYear-|">&lt;&lt;</a>&nbsp;&nbsp;
      <a href="Main.php?do=calendarEventsMonth&month=|-$nextMonth-|&year=|-$nextYear-|">&gt;&gt;</a></div>
