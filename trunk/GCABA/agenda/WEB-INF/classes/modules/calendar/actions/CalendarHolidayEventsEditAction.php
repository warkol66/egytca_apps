...
class CalendarHolidayEventsEditAction extends BaseAction {
	
	function CalendarHolidayEventsEditAction() {
		;
	}
	...
	function execute($mapping, $form, &$request, &$response) {
		...
		if ( !empty($_GET["id"]) ) {
			...
			$calendarEvent = CalendarHolidayEventQuery::create()->findOneById($_GET["id"]);
