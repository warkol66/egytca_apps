...
ECOTree = function (obj, elm) {
	this.config = {
		...
		nodeSelColor : "#FFFFCC",
		levelColors : ["#3030fd","#4545ff","#5151ff","#6375ff"],
		levelBorderColors : ["#3030fd","#4545ff","#5151ff","#6375ff"],
...
ECOTree._getAutoRenderMode = function() {
	...
	if (is_ff) r = "CANVAS";
	var is_sm = /SeaMonkey/i.test(navigator.userAgent);	
	if (is_sm) r = "CANVAS";
	return r;
}
...
ECOTree.prototype.toString = function () {	
	...
	{
		case "CANVAS":
			s.push('<canvas id="ECOTreecanvas" width=2000 height=5000></canvas>');
			break;
