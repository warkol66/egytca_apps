 ...
 */
class TableroStrategicObjectivePeer extends BaseTableroStrategicObjectivePeer {
	...
	*/
	...
	{
		$objectiveObj = new TableroStrategicObjective();
	...
	*/
	function update($id,$name,$affiliateId,$description) {
		$objectiveObj = TableroStrategicObjectivePeer::retrieveByPK($id);
	...
	*/
	function getByName($name,$con = null) {
		$cond = new Criteria();
		$cond->add(TableroStrategicObjectivePeer::NAME,$name);
		$objective = TableroStrategicObjectivePeer::doSelectOne($cond,$con);
		return $objective;
	 }
	...
	*/
	function getAll($affiliateId = null) {
		$cond = new Criteria();
		if ($affiliateId != null) {
			$cond->add(TableroStrategicObjectivePeer::AFFILIATEID,$affiliateId);
		}
		$alls = TableroStrategicObjectivePeer::doSelect($cond);
		return $alls;
	}
	...
	*/
	function getAllPaginated($page=1,$perPage=-1,$idAffiliate = null) {
		...
		$cond = new Criteria();
		if ($idAffiliate != null)
			$cond->add(TableroStrategicObjectivePeer::AFFILIATEID,$idAffiliate);
		$pager = new PropelPager($cond,"TableroStrategicObjectivePeer", "doSelect",$page,$perPage);
		return $pager;
	 }
	...
	private function getCriteria() {
		...
		if ($this->searchString)
			$criteria->add(TableroStrategicObjectivePeer::NAME,"%".$this->searchString."%",Criteria::LIKE);

		if ($this->affiliateId)
			$criteria->add(TableroStrategicObjectivePeer::AFFILIATEID,$this->affiliateId);
