<h2>Tablero de Control|-if $moduleConfig.useDependencies.value eq "YES"-||-if $loginUser-| - <a href="Main.php?do=tableroDependenciesShow">Dependencias</a> > |-/if-|
	...
	<a href="Main.php?do=tableroProcessesShow&objectiveId=|-$objective->getid()-|">|-$objective->getName()-|</a> > 
	|-$process->getName()-|</h2>
<h1>Indicadores del Proceso</h1>
<!-- Link VOLVER -->
<!-- /Link VOLVER -->
<p>A continuación se muestra la lista de Indicadores del Proceso.</p>
<div id="div_milestones">
	<table width='100%' border="0" cellpadding='5' cellspacing='0' class='tableTdBorders' id="tabla-milestones">
		<thead>
			...
			<tr>
				 <th colspan="5" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=tableroMilestonesEdit&processId=|-$process->getId()-|&show=1" class="addLink">Agregar Hito al Proceso</a></div></th>
			</tr>
			<tr>
		...
		|-foreach from=$milestones item=milestone name=for_milestones-|
			<tr>
				<td>|-$milestone->getid()-|</td>
				<td>|-$milestone->getname()-|</td>
				<td align="center">|-$milestone->getexpirationDate()|date_format:"%d-%m-%Y"-|</td>
				<td align="center">|-if $milestone->getcompleted() eq 0-|No|-else-|Si|-/if-|</td>
				<td nowrap>
...
<div id="div_indicators">
	<table width='100%' border="0" cellpadding='5' cellspacing='0'  class='tableTdBorders' id="tabla-indicators">
		<thead>
			...
			<tr>
				 <th colspan="7" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=tableroIndicatorsEdit&processId=|-$process->getId()-|&show=1" class="addLink">Agregar Indicador al Proceso</a></div></th>
			</tr>
			<tr>
		...
		|-foreach from=$indicators item=indicator name=for_indicators-|
			<tr>															
				...
				<td align="center">|-$indicator->getexpirationDate()|date_format:"%d-%m-%Y"-|</td>
				<td align="center">|-if $indicator->getstarted() eq 0-|No|-else-|Si|-/if-|</td>
				<td align="center">|-$indicator->getstartDate()|date_format:"%d-%m-%Y"-|</td>
				<td align="center">|-$indicator->getendDate()|date_format:"%d-%m-%Y"-|</td>
				<td align="center">|-$indicator->getactualProgress()-|</td>
				<td nowrap>																
					<form action="Main.php" method="get" style="display:inline;">
					...
					<ul>
						...
						<li>Fecha: |-$measure->getMeasureDate()-| - Valor: |-$measure->getMeasureNumber()-| - Valor Esperado: |-$measure->getMeasureExpectedNumber()-|
							<form action="Main.php" method="get">
								...
								<input type="submit" name="submit_go_edit_measure" value="Editar Medicion" />
								<input type="hidden" name="show" value="1" />																				
							</form>
						</li>
						|-/foreach-|
...
<div id="div_communes">
	<h4>Comunas Afectadas por el Proceso</h4>
		<ul id="communeList">
...
<div id="div_regions">
	<h4>Barrios Afectados por el Proceso</h4>
	<ul>
