...
require_once("TableroCommuneProjectPeer.php");

class TableroProjectsDoDeleteCommuneFromProjectXAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroProjectsDoDeleteCommuneFromProjectXAction() {
		;
	}
