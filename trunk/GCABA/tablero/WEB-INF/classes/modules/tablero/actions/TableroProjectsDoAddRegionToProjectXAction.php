...
require_once("TableroRegionProject.php");

class TableroProjectsDoAddRegionToProjectXAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroProjectsDoAddRegionToProjectXAction() {
		;
	}
	...
	function execute($mapping, $form, &$request, &$response) {
		...
		//TODO VERIFICACION USUARIOS
			...
			if (!empty($project) && !empty($region)) {
				...
				$relation = new TableroRegionProject();
