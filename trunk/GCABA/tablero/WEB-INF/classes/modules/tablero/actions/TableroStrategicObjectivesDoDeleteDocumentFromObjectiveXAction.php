...
class TableroStrategicObjectivesDoDeleteDocumentFromObjectiveXAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroStrategicObjectivesDoDeleteDocumentFromObjectiveXAction() {
		;
	}
