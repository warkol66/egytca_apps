...
class TableroProjectsBarNavAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroProjectsBarNavAction() {
		;
	}
	...
	*/
	function execute($mapping, $form, &$request, &$response) {
		...
		$projects = TableroProjectPeer::getAllByObjective($objectiveId,$dependencyId);
		$onTime = array();
		$delayed = array();
		$late = array();
		$labels = array();
		...
		$graph->subsubtitle->Set(Common::getTranslation(TableroProjectPeer::ITEM_NAME,'tablero'));
