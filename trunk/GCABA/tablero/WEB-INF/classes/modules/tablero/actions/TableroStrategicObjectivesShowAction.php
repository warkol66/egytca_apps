...
class TableroStrategicObjectivesShowAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroStrategicObjectivesShowAction() {
		;
	}
	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
  	...
  	$smarty->assign("section",$section);
		...
		$url = "Main.php?do=TableroStrategicObjectivesShow";
