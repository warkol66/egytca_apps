...
require_once("TableroCommuneProcess.php");

class TableroProcessesDoAddCommuneToProcessXAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroProcessesDoAddCommuneToProcessXAction() {
		;
	}
