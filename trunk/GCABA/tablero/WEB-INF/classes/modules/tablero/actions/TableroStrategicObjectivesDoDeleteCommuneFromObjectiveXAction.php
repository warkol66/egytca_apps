...
class TableroStrategicObjectivesDoDeleteCommuneFromObjectiveXAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroStrategicObjectivesDoDeleteCommuneFromObjectiveXAction() {
		;
	}
