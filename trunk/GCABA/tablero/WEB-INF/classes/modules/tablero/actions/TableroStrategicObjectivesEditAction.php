...
class TableroStrategicObjectivesEditAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroStrategicObjectivesEditAction() {
		;
	}
	...
	*/
	function execute($mapping, $form, &$request, &$response) {
		...
		if ( !empty($_GET["id"]) ) {
			...
			$objective = TableroStrategicObjectivePeer::get($_GET["id"]);
