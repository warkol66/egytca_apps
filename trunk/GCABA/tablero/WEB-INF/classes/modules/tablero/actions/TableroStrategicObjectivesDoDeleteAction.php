...
class TableroStrategicObjectivesDoDeleteAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroStrategicObjectivesDoDeleteAction() {
		;
	}
	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
		...
		$module = "Tablero";
    		...
    		$objective = TableroStrategicObjectivePeer::get($_POST["id"]);
