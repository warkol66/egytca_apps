...
class TableroStrategicObjectivesPlotGanttAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroStrategicObjectivesPlotGanttAction() {
		;
	}
	...
	*/
	function execute($mapping, $form, &$request, &$response) {
		...
		if (isset($_GET['objectiveId'])) {
			...
			$objective = TableroStrategicObjectivePeer::get($_GET['objectiveId']);
