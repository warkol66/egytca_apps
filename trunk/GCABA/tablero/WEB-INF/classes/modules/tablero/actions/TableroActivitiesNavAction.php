...
class TableroActivitiesNavAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroActivitiesNavAction() {
		;
	}
	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
		...
		if (!empty($_GET["status"])) {
			...
			$Activities = TableroActivityPeer::getAllByProject($_GET['projectId'],$dependencyId);		
		}
