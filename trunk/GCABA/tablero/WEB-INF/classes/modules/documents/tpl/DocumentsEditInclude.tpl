...
<form method="post" action="Main.php?do=documentsDoEdit" enctype="multipart/form-data" name="formSearch" id="documentsAdderForm" onsubmit="|-$onsubmit|default:'return true'-|">
	|-if $document neq ''-|
