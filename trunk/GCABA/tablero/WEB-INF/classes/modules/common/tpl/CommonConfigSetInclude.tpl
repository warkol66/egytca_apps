...
<li id="config[|-$section-|][|-$element_name-|]">|-$element_name|multilang_get_translation:$selectedModule-|
	<ul id="config[|-$section-|][|-$element_name-|]_ul">|-include file="CommonConfigSetInclude.tpl" elements=$element name="$name[$element_name]"-|</ul>
</li>
|-else-|
<li>
	<label>|-$element_name|multilang_get_translation:$selectedModule-|</label>
	|-if $element.element_type eq "Options"-|
		<select name="config[|-$section-|][|-$element_name-|][value]">
		...
		<input type="hidden" name="config[|-$section-|][|-$element_name-|][element_type]" value="|-$element.element_type-|" />
	  |-foreach from=$element.element_options item=option name=for_options-|
		<input type="hidden" name="config[|-$section-|][|-$element_name-|][element_options][option_|-$smarty.foreach.for_options.iteration-|]" value="|-$option-|" />
		|-/foreach-|
	...
	|-elseif $element.element_type eq "COLORCODE"-|
		...
		<img src="images/clear.png" class="aqua|-$colorCode-|" /><input name="config[|-$section-|][|-$element_name-|][value]" type="radio" value="|-$colorCode-|" |-if $element.value eq $colorCode-|checked="checked"|-/if-| />
			|-/foreach-|
		<input type="hidden" name="config[|-$section-|][|-$element_name-|][element_type]" value="|-$element.element_type-|" />
	|-elseif $element_name eq "language"-|
		<select name="config[|-$section-|][|-$element_name-|]">
	...
	|-elseif $element_name|substr:-8|lower eq 'password'-|
		<input name="config[|-$section-|][|-$element_name-|]" type="password" value="|-$element-|" size="15" />
	|-elseif $element|count_characters:true gt 120-|
		<textarea name="config[|-$section-|][|-$element_name-|]" cols="50" rows="5" wrap="VIRTUAL">|-$element|escape-|</textarea>
	|-elseif $element|count_characters:true gt 50-|
		<textarea name="config[|-$section-|][|-$element_name-|]" cols="50" rows="3" wrap="VIRTUAL">|-$element|escape-|</textarea>
	|-elseif $element|count_characters:true gt 30-|
		<input name="config[|-$section-|][|-$element_name-|]" type="text" value="|-$element|escape-|" size="55" />
	|-elseif $element|count_characters:true lt 5-|
		<input name="config[|-$section-|][|-$element_name-|]" type="text" value="|-$element|escape-|" size="5" />
	|-else-|
		<input name="config[|-$section-|][|-$element_name-|]" type="text" value="|-$element|escape-|" size="35" />
	|-/if-|
</li>
|-/if-|
|-/foreach-|
