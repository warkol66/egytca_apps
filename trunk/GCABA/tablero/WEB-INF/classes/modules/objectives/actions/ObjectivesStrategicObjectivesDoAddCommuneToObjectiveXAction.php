...
class ObjectivesStrategicObjectivesDoAddCommuneToObjectiveXAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function ObjectivesStrategicObjectivesDoAddCommuneToObjectiveXAction() {
		;
	}
