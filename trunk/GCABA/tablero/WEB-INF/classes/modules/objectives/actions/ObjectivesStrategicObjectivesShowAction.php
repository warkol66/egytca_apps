...
class ObjectivesStrategicObjectivesShowAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function ObjectivesStrategicObjectivesShowAction() {
		;
	}
	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
  	...
  	$smarty->assign("section",$section);
		...
		$url = "Main.php?do=objectivesStrategicObjectivesShow";
