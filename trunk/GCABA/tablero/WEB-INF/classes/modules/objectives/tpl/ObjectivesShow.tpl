			...
			<tr>
				...
				<td nowrap><form action="Main.php" method="get" style="display:inline;">
							<input type="hidden" name="do" value="tableroProjectsShow" />
								...
								<input type="submit" name="submit_go_view_objective" value="Ver Proyectos" class="icon iconView" />
						</form>
					...
					<form action="Main.php" method="post" style="display:inline;">
						...
						<input type="hidden" name="id" value="|-$objective->getid()-|" />
						<input type="submit" name="submit_go_delete_objective" value="Borrar" onclick="return confirm('Seguro que desea eliminar el objective?')" class="icon iconDelete" />
						<input type="hidden" name="show" value="1" />																				
				</form>								</td>
			</tr>
		|-/foreach-|						
