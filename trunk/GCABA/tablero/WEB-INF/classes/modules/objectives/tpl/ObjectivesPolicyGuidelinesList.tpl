...
<div id="div_guidelines">
	...
	<table id="tabla-guidelines" class='tableTdBorders' cellpadding='5' cellspacing='0' width='100%'>
		...
		<tr>
			...
			<tr>
				 <th colspan="|-if $configModule->get('global','applicationName') eq 'wb'-|7|-else-|4|-/if-|" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=objectivesPolicyGuidelinesEdit" class="addLink">Agregar ##objectives,1,Eje de Gestión##</a></div></th>
			</tr>
    ...
    |-if $configModule->get("global","applicationName") eq "wb"-|
		...
		|-/if-|
			<tr>
				 <th colspan="|-if $configModule->get('global','applicationName') eq 'wb'-|7|-else-|4|-/if-|" class="thFillTitle">|-if $guidelines|@count gt 5-|<div class="rightLink"><a href="Main.php?do=objectivesPolicyGuidelinesEdit" class="addLink">Agregar ##objectives,1,Eje de Gestión##</a></div>|-/if-|</th>
			</tr>
		</tbody>
	</table>
</div>
