...
<div id="div_objectives">
	...
	<table id="tabla-objectives" class='tableTdBorders' cellpadding='5' cellspacing='0' width='100%'>
		...
		<tr>
			...
			<tr>
				 <th colspan="|-if $moduleConfig.useDependencies.value =="YES"-|9|-else-|8|-/if-|" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=objectivesEdit" class="addLink">Agregar ##objectives,3,Objetivo##</a></div></th>
			</tr>
			...
			<!--	<th width="5%" class="thFillTitle">Id</th>-->
				...
				|-/if-|
				<th width="4%">Fecha</th>
				<th width="4%">Fecha de Expiración</th>
				<th width="4%">Logrado</th>
				<th width="4%">&nbsp;</th>
			</tr>
		</thead>
		...
		|-foreach from=$objectives item=objective name=for_objectives-|
			<tr>
				...
				<td>|-assign var=position value=$objective->getPosition()-||-if !empty($position)-||-$position->getOwnerName()-| &#8212; |-assign var=tenure value=$position->getActiveTenure()-| |-if $tenure->getObject() != NULL-||-assign var=tenureObject value=$tenure->getObject()-||-$tenureObject->getName()-| |-$tenureObject->getSurname()-||-/if-||-/if-|</td>
				|-if $moduleConfig.useDependencies.value =="YES"-|
		...
		|-if isset($pager) && ($pager->getTotalPages() gt 1)-|
			<tr> 
				<td colspan="|-if $moduleConfig.useDependencies.value =="YES"-|9|-else-|8|-/if-|" class="pages">|-include file="PaginateInclude.tpl"-|</td> 
			</tr>
		|-/if-|
		|-/if-|
			<tr>
				<th colspan="|-if $moduleConfig.useDependencies.value =="YES"-|9|-else-|8|-/if-|" class="thFillTitle">|-if $objectives|@count gt 5-|<div class="rightLink"><a href="Main.php?do=objectivesEdit" class="addLink">Agregar ##objectives,3,Objetivo##</a></div>|-/if-|</th>
			</tr>
		</tbody>
	</table>
</div>
