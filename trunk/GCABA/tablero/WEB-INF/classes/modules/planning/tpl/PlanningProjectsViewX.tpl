...
|-assign var=activities value=$planningProject->getActivities()-|
	...
	|-capture name=task-|
			<tasks>|-foreach from=$activities item=activity name=for_contractActivitys-|<task start='|-$activity->getStartingDate()|date_format:"%d/%m/%Y"-|' end='|-$activity->getEndingDate()|date_format:"%d/%m/%Y"-|' label='|-$activity|escape:"javascript"-|' showLabel='1' id='|-$activity->getid()-|' showborder='0'/>|-/foreach-|</tasks>			<milestones>|-foreach from=$activities item=activity name=for_contractActivitys-||-if $activity->getStartingDate() eq $activity->getEndingDate()-|<milestone date='|-$activity->getEndingDate()|date_format:"%d/%m/%Y"-|' taskId='|-$activity->getid()-|' radius='10' color='333333' shape='Star' numSides='5' borderThickness='1' tooltext='|-$activity->getEndingDate()|date_format:"%d/%m/%Y"-|'/>|-/if-||-/foreach-|</milestones></chart>|-/capture-| 
