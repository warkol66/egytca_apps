...
|-assign var=activities value=$planningConstruction->getActivities()-|
	...
	|-capture name=task-|<tasks>|-foreach from=$activities item=activity name=for_contractActivitys-|<task start='|-$activity->getEndingDate()|date_format:"%d/%m/%Y"-|' end='|-$activity->getEndingDate()|date_format:"%d/%m/%Y"-|' label='|-$activity|escape:"javascript"-|' showLabel='1' id='|-$activity->getid()-|' showborder='0'/>|-/foreach-|</tasks><milestones>|-foreach from=$activities item=activity name=for_contractActivitys-|<milestone date='|-$activity->getEndingDate()|date_format:"%d/%m/%Y"-|' taskId='|-$activity->getid()-|' radius='10' color='333333' shape='Star' numSides='5' borderThickness='1' tooltext='|-$activity|escape:"javascript"-|, |-$activity->getEndingDate()|date_format:"%d/%m/%Y"-|'/>|-/foreach-|</milestones></chart>|-/capture-| 
<div id="chartdiv" align="center">Diagrama de Gantt</div>
<script type="text/javascript">|-assign var=height value="450"-||-math equation="q * y" q=$planningConstruction->countActivities() y="35" assign=calculatedHeight-|
