...
<div id="div_guarantees"> 
	...
	<table id="tabla-guarantees" class='tableTdBorders' cellpadding='5' cellspacing='0' width='100%'> 
        ...
        <option value="|-$contractor->getId()-|" |-$contractor->getId()|selected:$filters.searchContractorId-|>|-$contractor->getName()|truncate:75:"...":false-|</option> 
			...
			<tr>
				 <th colspan="8" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=panelGuaranteesEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addLink">Agregar Garantía</a></div></th>
			</tr>
	...
	<!--		<td>|-$guarantee->getid()-|</td> -->
		...
		|-/if-|
			<tr>
				 <th colspan="8" class="thFillTitle">|-if $guarantees|@count gt 5-|<div class="rightLink"><a href="Main.php?do=panelGuaranteesEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addLink">Agregar Garantía</a></div>|-/if-|</th>
			</tr>
		|-/if-|
		</tbody> 
		 </table> 
