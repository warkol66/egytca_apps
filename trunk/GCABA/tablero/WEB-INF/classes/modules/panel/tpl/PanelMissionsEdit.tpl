    ...
    <li id="partyListItem|-$party->getId()-|">|-$party->getName()-|
      <form  method="post"> 
        ...
        <input type="hidden" name="partyId"  value="|-$partie->getId()-|" /> 
				<input type="button" value="Eliminar" title="Eliminar" onClick="if (confirm('¿Seguro que desea eliminar al participante del misión?')){deletePartyFromAdminAct(this.form)}; return false" class="icon iconDelete" /> 
     </form> 
    </li> 
    |-/foreach-|
  </ul> 
