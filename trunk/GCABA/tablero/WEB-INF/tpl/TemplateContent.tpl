...
/**
* TemplateContent
* Template externo para contenido
*
...
<title>|-$contentData.title-| - |-$parameters.siteName-|</title>
...
<script type="text/javascript" src="scripts/prototype.js" language="JavaScript"></script>
...
<div id="bkg">	
   ...
   <div id="wrapper">
        ...
        <div id="logo1"><a href="Main.php?do=newsArticlesShow" alt="|-$parameters.siteName-|"></a></div>
				|-include_module module=Content action=Menu options="noParent=0&depth=1&id=20&template=ContentMenuTopHorizontalInclude.tpl"-|
         </div>
		 <!-- End Header -->
			<div id="topImage_|-2|rand:13-|_|-$currentLanguageCode-|"></div>
		 <div id="sloganLine">
	 ...
	 <!-- End sloganLine-->
		...
		|-*include_module module=Content action=Menu options="noParent=1&depth=4&id=$contentId&topDepth=3&topDepthContentLimitId=1"*-|
		<p>&nbsp;</p>
		<p>&nbsp;</p>
...
|-/if-|
	...
	|-/if-|
			...
			|-$centerHTML-|
			|-if ($contentData.content|strlen eq 0)-|<!--Entra texto por default-->
				|-include_module module=Content action=Show options="id=109"-|
			|-/if-|
			</div><!-- End contentBody -->
			...
			<div id="rightcolumn">
				...
				|-if $contentData.id|is_descendant:21-|
					|-include_module module=Banners action=ZonesDisplay options="id=3&template=BannersZonesDisplayIncludeRightColumn.tpl"-|
				|-elseif $contentData.id|is_descendant:22-|
					|-include_module module=Banners action=ZonesDisplay options="id=4&template=BannersZonesDisplayIncludeRightColumn.tpl"-|
				|-elseif $contentData.id|is_descendant:23-|
					|-include_module module=Banners action=ZonesDisplay options="id=5&template=BannersZonesDisplayIncludeRightColumn.tpl"-|
				|-elseif $contentData.id|is_descendant:24-|
					|-include_module module=Banners action=ZonesDisplay options="id=6&template=BannersZonesDisplayIncludeRightColumn.tpl"-|
				|-else-|
