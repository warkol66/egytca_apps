...
<div id="div_internalMail">
	<p>Ingrese los datos del mensaje</p>
		<p><a href="#" onClick="location.href='Main.php?do=servicesInternalMailsList|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($page)-|&page=|-$page-||-/if-|'">Volver atras</a>
		</p>
	|-if $message eq "ok"-|
...
|-/if-|			
			...
			<p>
				<input type="hidden" name="do" id="do" value="servicesInternalMailsDoEdit" />
				...
				<input type="button" id="cancel" name="cancel" title="Cancelar y volver al listado" value="Cancelar" onClick="location.href='Main.php?do=servicesInternalMailsList|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($page)-|&page=|-$page-||-/if-|'"/>
			</p>
		</fieldset>
	</form>
</div>