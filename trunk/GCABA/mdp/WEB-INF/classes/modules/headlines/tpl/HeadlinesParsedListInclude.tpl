...
|-if $headlinesParsed|count gt 0-|
    ...
    <strong>&nbsp; &nbsp; |-$headline->getName()-|</strong>|-if $headline->getMoreSourcesUrl() ne ''-|<span id="parseMore_|-$headline->getId()-|" style="float: right; margin-right: 100px;"><img src="images/clear.png" class="icon iconAdd" onClick='parseMore("|-$headline->getId()-|;"); $("parseMore_|-$headline->getId()-|").parentNode.removeChild($("parseMore_|-$headline->getId()-|"));' value="Mas similares" /> <strong>Buscar similares</strong></span>|-/if-|
		<ul><li>
			...
			|-$headline->getContent()|mb_truncate:495:" ... ":'UTF-8':true|highlight:['Macri','Larrta','Ritondo','IVC','Piccardo','Michetti','Pinedo','Bullrich','Vidal','Lombardi','Chaín','Cabrera','Lemus','Santilli','Dietrich','Macchiavelli','Montenegro','Ibarra','Basavilbaso','Irarrázaval','Legislatura','Legislador','Corcuera','CGP','Comuna','Barrio','Porteño','Retiro','Constitución','Belgrano','Nuñez','Derrumbe','CMD','Marcos Peña','Durán Barba','Agencia Gubernamental de Control','Banco Ciudad','Teatro Colón','Policía Metropolitana','Capital Federal','Ciudad de Buenos Aires','Ciudad Autónoma de Buenos Aires']:highlight-|
				<img id="imgMore|-$headline->getId()-|" src="images/clear.png" onClick="$('more|-$headline->getId()-|').toggle();$('imgMore|-$headline->getId()-|').toggleClassName('inlineLink readLess')" class="inlineLink readMore" title="Ver/Ocultar texto" /><span id="more|-$headline->getId()-|" style="display: none ">|-$headline->getContent()|mb_substr:490:3000:'UTF-8'|highlight:['Macri','Larrta','Ritondo','IVC','Piccardo','Michetti','Pinedo','Bullrich','Vidal','Lombardi','Chaín','Cabrera','Lemus','Santilli','Dietrich','Macchiavelli','Montenegro','Ibarra','Basavilbaso','Irarrázaval','Legislatura','Legislador','Corcuera','CGP','Comuna','Barrio','Porteño','Retiro','Constitución','Belgrano','Nuñez','Derrumbe','CMD','Marcos Peña','Durán Barba','Agencia Gubernamental de Control','Banco Ciudad','Teatro Colón','Policía Metropolitana','Capital Federal','Ciudad de Buenos Aires','Ciudad Autónoma de Buenos Aires']:highlight-|</span>
			|-else-|
				|-$headline->getContent()|highlight:['Macri','Larrta','Ritondo','IVC','Piccardo','Michetti','Pinedo','Bullrich','Vidal','Lombardi','Chaín','Cabrera','Lemus','Santilli','Dietrich','Macchiavelli','Montenegro','Ibarra','Basavilbaso','Irarrázaval','Legislatura','Legislador','Corcuera','CGP','Comuna','Barrio','Porteño','Retiro','Constitución','Belgrano','Nuñez','Derrumbe','CMD','Marcos Peña','Durán Barba','Agencia Gubernamental de Control','Banco Ciudad','Teatro Colón','Policía Metropolitana','Capital Federal','Ciudad de Buenos Aires','Ciudad Autónoma de Buenos Aires']:highlight-|
			|-/if-|
		</li></ul>
    </li>
    |-/foreach-|
