...
<h1>Administración de Categorías de ##issues,1,Asuntos##</h1>
	<!-- /Link VOLVER -->
<p>A continuación podrá editar la lista de categorías de ##issues,1,Asuntos## del sistema.</p>
				...
				<td colspan="3" class="tdSearch"><div><a href="javascript:void(null);" onClick='switch_vis("divSearch");' class="tdTitSearch">Buscar</a></div>
					<div id="divSearch" style="display:|-if $filters|@count gt 0-|block|-else-|none|-/if-|;">
						<form action='Main.php' method='get' style="display:inline;">
							<input type="hidden" name="do" value="issuesCategoryList" />
							Nombre:
						...
						<form  method="get">
							<input type="hidden" name="do" value="issuesCategoryList" />
							|-if isset($filters.searchString)-|<input type="submit" value="Quitar Filtros" onClick="location.href='Main.php?do=issuesCategoryList'" />|-/if-|
						</form>
					</div></td>
			</tr>
			<tr>
				<th colspan="3" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=issuesCategoryEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addLink">Agregar Categoría</a></div></th>
			</tr>
			<tr>
