...
<div id="div_sources"> 
	|-if $message eq "deleted_ok"-|
		<div class="successMessage" id="actionMessage">Departamento eliminado correctamente</div>
	|-/if-|
	...
	<table id="table_sources" class='tableTdBorders' cellpadding='5' cellspacing='0' width='100%'> 
		...
		<tr>
			<th colspan="2" class="thFillTitle">
				<div class="rightLink">
					<a href="#" onclick="toggleInput('addInput1', 'addLink1'); return false;" id="addLink1" class="addLink">Agregar Departamento</a>
	...
	|-include file="VialidadDepartmentsListInclude.tpl"-|
		...
		<tr>
			<th colspan="2" class="thFillTitle">
				<div class="rightLink">
					<a href="#" onclick="toggleInput('addInput2', 'addLink2'); return false;" id="addLink2" class="addLink">Agregar Departamento</a>
