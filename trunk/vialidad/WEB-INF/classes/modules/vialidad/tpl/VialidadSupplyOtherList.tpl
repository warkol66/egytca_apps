<h2>Insumos</h2>
<h1>Administración de Otros Insumos</h1>
<p>A continuación se muestra la lista de Otros Insumos cargados en el sistema.</p>
<div id="div_supplies"> 
			...
			<td colspan="3" class="tdSearch"><a href="javascript:void(null);" onClick='switch_vis("divSearch");' class="tdTitSearch">Búsqueda de Insumos </a>
				...
				<form action='Main.php' method='get' style="display:inline;">
					...
					&nbsp;&nbsp;&nbsp;
						...
						<input type="hidden" name="do" value="vialidadSupplyOtherList" />
						&nbsp;&nbsp;
						|-if $filters|@count gt 0-|
						<input type="button" value="Quitar Filtros" onclick="location.href='Main.php?do=vialidadSupplyOtherList'"/>
						|-/if-|
					</p>
				</form>
				</div>
