...
/**
 * Skeleton subclass for performing query and update operations on the 'vialidad_measurementRecordRelation' table.
 *
 * 
 *
 ...
 */
class MeasurementRecordRelationQuery extends BaseMeasurementRecordRelationQuery {
	...
	public function addFilter($filterName, $filterValue) {
		...
		switch ($filterName) {
			case 'SearchString':
				...
				break;
			default:
				if (in_array($filterName, MeasurementRecordRelationPeer::getFieldNames(BasePeer::TYPE_PHPNAME)))
...
} // MeasurementRecordRelationQuery
