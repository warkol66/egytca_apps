...
/**
 * Skeleton subclass for performing query and update operations on the 'vialidad_constructionItemRelation' table.
 *
 * 
 *
 ...
 */
class ConstructionItemRelationQuery extends BaseConstructionItemRelationQuery {
	...
	public function addFilter($filterName, $filterValue) {
		...
		switch ($filterName) {
			case 'SearchString':
				...
				break;
			default:
				if (in_array($filterName, ConstructionItemRelationPeer::getFieldNames(BasePeer::TYPE_PHPNAME)))
