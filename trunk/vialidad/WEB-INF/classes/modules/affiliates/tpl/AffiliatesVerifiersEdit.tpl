	...
	<fieldset title="Formulario de edición de nombre de Fiscalizadora">
		...
		<p>Realice los cambios y para guardar haga click en "Guardar Cambios"</p>
		 ...
		 <p><label for="params[internalNumber]">RUC</label>
			<input name="params[internalNumber]" type="text" class="emptyValidation" id="params[internalNumber]" value="|-$affiliate->getInternalNumber()|escape-|" size="9" maxlength="9" title="Ingrese el RUC sin guiones"> 
