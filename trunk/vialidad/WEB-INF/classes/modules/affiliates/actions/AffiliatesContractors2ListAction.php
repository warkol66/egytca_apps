...
class AffiliatesContractors2ListAction extends BaseAction {
	...
	function execute($mapping, $form, &$request, &$response) {
		...
		$contractors = ContractorQuery::create()->addFilters($filters);
		$pager = $contractors->paginate($_GET["page"],$filters["perPage"]);

		$url = "Main.php?do=affiliatesContractors2List";
