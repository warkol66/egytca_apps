<div id="categoriesListPlaceHolder">
	...
	|-if ($selectedModule neq '')-|
		<fieldset>
			...
			|-include file="DocumentsShowCategoriesTreeInclude.tpl" user=$user categories=$categories-|
			<br />
			<p><a href='Main.php?do=documentsShow'>Mostrar todos las categorías disponibles</a></p>
		</fieldset>
	|-else-|
		<!--pedido de todos los módulos y categorías generales y documentos sin categorías -->
		<fieldset>
			<legend>Categorías Disponibles</legend>
			<p>Documentos sin categorías</p>
				<ul>
					<li>
						<a href="Main.php?do=documentsShow&amp;categoryId=0">|-if $categoryId eq 0-|<strong>|-/if-|Documentos sin categoría (|-$documentsWithoutCategoryCount-|)|-if $categoryId eq 0-|</strong>|-/if-|</a>
					</li>
				</ul>
			<br />
			|-if $generalParentCategories|@count neq 0-|
				<p>Categorías Generales</p>
				|-include file="DocumentsShowCategoriesTreeInclude.tpl" user=$user categories=$generalParentCategories-|
			|-/if-|
			<br />
