<div id="div_paginate" style="text-align:center">
	...
	<div id="paginatePage" class="paginateText">|-assign var="page" value=$pager->getPage()-||-if $page ne ''-| P&aacute;gina: |-$page-| de |-$pager->getLastPage()-| |-/if-|
	</div>
    ...
    <div id="paginateLast" class="paginateText">|-assign var="lastpage" value=$pager->getLastPage()-||-if $lastpage neq $page-|<a href="|-$url-|&page=|-$lastpage-|" class="detail">&Uacute;ltima</a>|-else-|<span class="deactivated">&Uacute;ltima</span>|-/if-|
	</div>
</div>
