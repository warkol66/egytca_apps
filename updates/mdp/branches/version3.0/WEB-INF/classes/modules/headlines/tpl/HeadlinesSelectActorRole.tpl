...
<p id='p_role_for_|-$actorId-|' |-if $action neq 'show'-|style="display:none;"|-else-|style="display:inline;"|-/if-| onMouseOver='this.style.background="yellow";' onMouseOut='this.style.background="#F7F7F8";' onClick='displayRoleSelector(|-$actorId-|);'>|-$roles[$role]-|</p>
