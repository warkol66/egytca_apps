...
|-if $headlinesParsed|count gt 0-|
    ...
    <li id="li_|-$headline->getId()-|"><a href="#lightbox1" rel="lightbox1" class="lbOn">
		...
		<strong>&nbsp; &nbsp; |-$headline->getName()-|</strong>|-if $headline->getMoreSourcesUrl() ne ''-|<span style="float: right; margin-right: 100px;"><img src="images/clear.png" class="icon iconAdd" onClick='{new Ajax.Updater("list", "Main.php?do=headlinesParsedMoreX&id=|-$headline->getId()-|", { method: "post", parameters: { id: "|-$headline->getId()-|"}, evalScripts: true, insertion: "top"})};$("viewWorking").innerHTML = "<span class=\"inProgress\">buscando más titulares...</span>";' value="Mas similares" /> <strong>Buscar similares</strong></span>|-/if-|
		<ul><li>
