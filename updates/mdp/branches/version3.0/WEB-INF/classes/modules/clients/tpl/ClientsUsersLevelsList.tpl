...
<table class='tablaborde' cellpadding='5' cellspacing='1' width='100%'>
	<tr class="thFillTitle">
			<th colspan="8"><div class="rightLink"><a href="Main.php?do=clientsUsersLevelsEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addLink">Agregar ##clients,1,Cliente##</a></div></th>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="1%" nowrap>
			<form action="Main.php" method="get" style="display:inline;"> 
			  <input type="hidden" name="do" value="clientsUsersLevelsEdit" /> 
			...
			<form action="Main.php" method="post" style="display:inline;"> 
			  <input type="hidden" name="do" value="clientsUsersLevelsDoDelete" /> 
			  <input type="hidden" name="id" value="|-$level->getId()-|" /> 
			  <input type="submit" name="submit_go_delete_client" value="Borrar" title="Eliminar" class="icon iconDelete" onclick="return confirm('Seguro que desea eliminar el nivel de usuario?')"  /> 
			</form>
		</td>
	</tr>
	|-/foreach-|
