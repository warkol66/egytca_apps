<?php
/**
 * ClientsUsersPasswordDoRecoverAction
 *
 * @package clients
 */

class ClientsUsersPasswordDoRecoverAction extends BaseAction {

	function ClientsUsersPasswordDoRecoverAction() {
		;
	}
	...
	function execute($mapping, $form, &$request, &$response) {
		...
		$user = ClientUserPeer::getByRecoveryHash($_GET["recoveryHash"]);
