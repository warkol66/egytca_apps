...
|-if $clients|@count gt 0-|			<tr>
		...
		<form action="Main.php" method="get"> 
				...
				<input type="hidden" name="do" value="clientsBranchesList" /> 
				<input type="submit" value="Buscar" /> 
				|-if $filters.searchClientId gt 0-|<input name="rmoveFilters" type="button" value="Quitar filtros" onclick="location.href='Main.php?do=clientsBranchesList';" />|-/if-|</p>
		</form> 
</th>
			</tr>|-/if-|
			<tr>
				<th colspan="8"><div class="rightLink"><a href="Main.php?do=clientsBranchesEdit" class="addLink">Agregar ##clients,4,Sucursal##</a></div></th>
			</tr>
			<tr> 
      ...
      <td>|-$branch->getCode()-|</td> 
			...
			<td class="tdSize1 center" nowrap="nowrap"> <form action="Main.php" method="get" style="display:inline;"> 
					<input type="hidden" name="do" value="clientsBranchesEdit" /> 
				...
				<form action="Main.php" method="post" style="display:inline;"> 
					<input type="hidden" name="do" value="clientsBranchesDoDelete" /> 
					<input type="hidden" name="id" value="|-$branch->getid()-|" /> 
					|-include file="FiltersRedirectInclude.tpl" filters=$filters-|
					|-if isset($pager) && ($pager->getPage() ne 1)-| <input type="hidden" name="page" id="page" value="|-$pager->getPage()-|" />|-/if-|
