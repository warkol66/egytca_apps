...
<form method='post' action='Main.php?do=clientsUsersGroupsDoEdit'>
	<fieldset title="Formulario de edición de grupo de usuario">
	<legend>Grupo de Usuarios por Clientes</legend>
		<input type="hidden" name="id" value="|-$currentGroup->getId()-|" />
		<input type="hidden" name="do" value="clientsUsersGroupsDoEdit" />
		<p>
...
<fieldset title="Formulario de edición de categorias de grupo de usuario">
	...
	<tr>
		...
		<form action="Main.php" method="post" style="display:inline;"> 
			<input type="hidden" name="do" value="clientsUsersGroupsDoRemCategory" /> 
	...
	<p>
		<form action='Main.php' method='post'>
			...
			<input type="hidden" name="do" value="clientsUsersGroupsDoAddCategory" />
			<input type="hidden" name="group" value="|-$currentGroup->getId()-|" />
