<h2>##clients,5,Sucursales##</h2> 
 ...
 <div id="div_branch"> 
	...
	<p>
		...
		<input type="hidden" name="do" id="do" value="clientsBranchsDoEdit" /> 
		<input type="submit" id="button_edit_branch" name="button_edit_branch" title="Aceptar" value="Aceptar" />
		<input name="rmoveFilters" type="button" value="Cancelar" onclick="location.href='Main.php?do=clientsBranchsList|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($page)-|&page=|-$page-||-/if-|'"  />	</p>
	</fieldset>
	</form> 
</div>
