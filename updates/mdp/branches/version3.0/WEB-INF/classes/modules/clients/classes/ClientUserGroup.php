...
/**
 * Skeleton subclass for representing a row from the 'clients_userGroup' table.
 *
 * Users / Groups
 *
 ...
 */
class ClientUserGroup extends BaseClientUserGroup {
	...
	*/
	function getCategories() {
		$cond = new Criteria();
		$cond->add(ClientGroupCategoryPeer::GROUPID, $this->getId());
