<?php
/** 
 * ClientsUsersDoPasswordRecoveryAction
 *
 * @package clients 
 */

class ClientsUsersDoPasswordRecoveryAction extends BaseAction {

	function ClientsUsersDoPasswordRecoveryAction() {
		;
	}
    ...
    BaseAction::execute($mapping, $form, $request, $response);
		...
		if (!empty($_POST["username"]) && !empty($_POST["mailAddress"])) {
			$userAndPassword = ClientUserPeer::generatePassword($_POST["username"],$_POST["mailAddress"]);
