	...
	<div id="login">
		...
		<form method='post' action="Main.php"> 
		 ...
		 <div id="loginContent"><br />
			...
			|-/if-|
				<input type="hidden" name="do" value="clientsUserDoLogin" id="loginFormDo" />
			<h1>Usuario</h1> 
		...
		<!--[if lte IE 6]><p>Su versión actual de navegador es IExplorer 6.<br />Este sistema requiere que utilice una versión mas nueva de Interntet Explorer.<br />
		 ...
		 <div id="loginBottom">
			...
			<div id="lostPassword"><a href="Main.php?do=clientsUserPasswordRecovery">¿Olvidó su contraseña?</a></div>
		</div><!-- End LoginBottom --> 
		</form> 
