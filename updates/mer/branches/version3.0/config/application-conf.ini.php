...
// from XML runtime conf file C:\apache\htdocs2\apps\updates\mer\branches\version3.0\WEB-INF\propel\runtime-conf.xml
$conf = array (
  'datasources' => 
  array (
    'application' => 
    array (
      ...
      'connection' => 
      array (
        'dsn' => 'mysql:host=localhost; dbname=sigmamer_new',
        'user' => 'root',
        'password' => 'vertrigo',
      ),
    ),
