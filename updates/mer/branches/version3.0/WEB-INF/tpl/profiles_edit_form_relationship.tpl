...
|-foreach from=$forms item=form -|
		|-include file=profiles_edit_form_relationship_section.tpl section=$form->getRootSection() -|
	|-/foreach-| <br />
	<script>
...
//		alert(nue.cat.options[nue.cat.selectedIndex].value);
	...
	<form onSubmit='checkCat(this)' action="Main.php?do=doProfilesFormRelEdit&questionId=|-$question->getId()-|&edit=1" method="POST">
