...
|-if $smarty.request.showAll-|
	|-assign var=questions value=$section->getQuestionsOrder($actor)-|
|-else-|
	|-assign var=questions value=$section->getQuestionsForActor($actor)-|
|-/if-|
|-foreach from=$questions item=question-|
	<tr>	
		<td width='55%' valign='top' class='celltitulo'><div class='titulo2'><label for='q_|-$question->getId()-|'>|-$question->getQuestion()-|</label></div></td>
	|-if $smarty.request.showAll-|
...
|-foreach from=$section->getChildSections() item=childSection-|
	<tr>
		<td style='padding-left:12px;' colspan='|-if $smarty.request.showAll-|3|-else-|2|-/if-|' class='cellwhite' width="100%">
			|-include file=profiles_fill_form_section.tpl section=$childSection -|
		</td>
	</tr>
|-/foreach-|
</table>