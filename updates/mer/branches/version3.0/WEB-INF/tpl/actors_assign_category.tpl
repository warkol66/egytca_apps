...
<form name="form1" method="post" action="Main.php">
	<table class='tableTdBorders' width='100%' border='0' cellspacing='1' cellpadding='5'>
		...
		<tr valign="top">
			...
			<td class='cellopciones' width='10%' nowrap><a href='Main.php?do=actorsEditActorCategory&actor=|-$actor->getId()-|' title="Editar"><img src="images/clear.png" class="icon iconEdit" /></a>
				<a href='Main.php?do=actorsDoDeleteActor&actor=|-$actor->getId()-|' title="Eliminar" onclick="return confirm('##116,Esta opción eliminar permanentemente a este Actor\n¿Está seguro que desea eliminarlo?##');"><img src="images/clear.png" class="icon iconDelete" /></a></td>
		</tr>
		|-/foreach-|
		<tr>
