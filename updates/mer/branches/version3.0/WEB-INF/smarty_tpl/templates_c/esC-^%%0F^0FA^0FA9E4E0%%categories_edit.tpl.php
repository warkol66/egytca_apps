<?php /* Smarty version 2.6.26, created on 2011-05-04 14:42:11
         compiled from categories_edit.tpl */ ?>
...
<form method='post'>
	<table class='tablaborde' width='100%' border='0' cellspacing='1' cellpadding='0'>
		...
		<tr>
			...
			<td class='celldato'><input name="name" type="text" value='<?php echo $this->_tpl_vars['category']->getName(); ?>
' size="50" class='textodato' /></td>
		</tr>
		<tr>
			<td nowrap="nowrap" class='titulodato1'>##148,Cantidad Máxima de Actores Clave##:</td>
			<td class='celldato'><input name="hierarchyActors" type="text" value='<?php echo $this->_tpl_vars['category']->getHierarchyActors(); ?>
' size="2" maxlength="2" class='textodato' /></td>
		</tr>
		<tr>
			<td colspan="2" class='cellboton'><input type="hidden" name="id" id="id" value="<?php echo $this->_tpl_vars['category']->getId(); ?>
" />
