...
<table width="760" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td width="99" valign="top" class="fondomenu"><a href="index.php?modulo=inicio"><img src="images/merlogo_n3.png" width="99" height="80" border="0"></a><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "menu_left.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
			<p>&nbsp;</p></td>
		<td height='500' valign='top' class='fondoffffff'><table width='100%' border='0' cellspacing='0' cellpadding='0' height='20' class='filled1'>
				<tr>
					<td valign='top'><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "menu_upper.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?></td>
				</tr>
