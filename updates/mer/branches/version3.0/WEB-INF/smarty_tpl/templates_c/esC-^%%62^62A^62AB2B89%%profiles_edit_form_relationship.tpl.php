<?php /* Smarty version 2.6.26, created on 2011-05-04 14:51:06
         compiled from profiles_edit_form_relationship.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'profiles_edit_form_relationship.tpl', 54, false),)), $this); ?>
<table border='0' cellpadding='0' cellspacing='0' width='100%'>
	...
	<tr>
		<td class='texto'><span class="comentariostd">##217,En esta sección podrá administrar las indicadores de intercambio y relación entre Actores. Para agregar preguntas puede hacer## <a href="#edit">##93,click aquí##</a>. </span></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "profiles_edit_form_relationship_section.tpl", 'smarty_include_vars' => array('section' => $this->_tpl_vars['form']->getRootSection())));
...
//		alert(nue.cat.options[nue.cat.selectedIndex].value);
	...
	<form onSubmit='checkCat(this)' action="Main.php?do=doProfilesFormRelEdit&questionId=<?php echo $this->_tpl_vars['question']->getId(); ?>
&edit=1" method="POST">
...
"><?php if ($this->_tpl_vars['typeName'] == 'String'): ?>##300,Texto##<?php elseif ($this->_tpl_vars['typeName'] == 'Text'): ?>##300,Texto largo##<?php elseif ($this->_tpl_vars['typeName'] == 'Money'): ?>##300,Moneda##<?php elseif ($this->_tpl_vars['typeName'] == 'Date'): ?>##300,Fecha##<?php elseif ($this->_tpl_vars['typeName'] == 'Number'): ?>##300,Número##<?php elseif ($this->_tpl_vars['typeName'] == 'Boolean'): ?>##300,Cierto o falso##<?php endif; ?></label>
					...
					<?php else: ?>
					<tr>
						<td valign='top' class="celldato"><input type='radio' name='questionType' value='3' <?php if ($this->_tpl_vars['question']->getType() == $this->_tpl_vars['typeId']): ?>checked='checked'<?php endif; ?> onClick='switch_vis("optionsTable","block");' />##229,Opciones##</td>
						<td class="celldato"><div id="optionsTable" style='display:<?php if ($this->_tpl_vars['question']->getType() == $this->_tpl_vars['typeId']): ?>block<?php else: ?>none<?php endif; ?>;'><table width="100%" border="0" cellpadding="3" cellspacing="1" class="tablaborde0">
								<tr>
