...
* @public
*/
class MenuGuardarAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function MenuGuardarAction() {
		;
	}
	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
		...
		$db->connect();
		$menu = new Menu();
		$menu->guardar($_POST['id'],$_POST['descripcion'],$_POST['action'],$_POST['orden'],$_POST['parametro']);
		...
		if (empty($_REQUEST['id']))
			return $mapping->findForwardConfig('agregado');
		else
			return $mapping->findForwardConfig('editado');
