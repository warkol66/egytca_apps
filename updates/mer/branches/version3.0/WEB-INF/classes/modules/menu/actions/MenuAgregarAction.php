...
* @public
*/
class MenuAgregarAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function MenuAgregarAction() {
		;
	}
	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
		...
		{
			list($registro) = $menu->obtenerRegistro($_REQUEST['id']);
			$smarty->assign("registro",$registro);			
			$smarty->assign("ACTION",$registro['action']);
		}
		else
			{
