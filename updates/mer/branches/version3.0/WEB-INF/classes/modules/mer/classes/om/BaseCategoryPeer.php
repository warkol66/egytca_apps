...
/**
 * Base static class for performing query and update operations on the 'MER_category' table.
 *
 * Categorias
 *
...
abstract class BaseCategoryPeer {
	...
	const TABLE_NAME = 'MER_category';

	/** the related Propel class for this table */
	const OM_CLASS = 'Category';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'mer.classes.Category';
	...
	const ID = 'MER_category.ID';

	/** the column name for the NAME field */
	const NAME = 'MER_category.NAME';

	/** the column name for the ACTIVE field */
	const ACTIVE = 'MER_category.ACTIVE';

	/** the column name for the HIERARCHYACTORS field */
	const HIERARCHYACTORS = 'MER_category.HIERARCHYACTORS';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Active', 'Hierarchyactors', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'active', 'hierarchyactors', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::ACTIVE, self::HIERARCHYACTORS, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'ACTIVE', 'HIERARCHYACTORS', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'active', 'hierarchyActors', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Active' => 2, 'Hierarchyactors' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'active' => 2, 'hierarchyactors' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::ACTIVE => 2, self::HIERARCHYACTORS => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'ACTIVE' => 2, 'HIERARCHYACTORS' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'active' => 2, 'hierarchyActors' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CategoryPeer::HIERARCHYACTORS);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.NAME');
			$criteria->addSelectColumn($alias . '.ACTIVE');
			$criteria->addSelectColumn($alias . '.HIERARCHYACTORS');
		}
	}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to MER_category
	...
	/**
	 * Method to DELETE all rows from the MER_category table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(DocumentPeer::CATEGORYID, $obj->getId());
			...
			$criteria->add(GraphActorPeer::CATEGORYID, $obj->getId());
			...
			$criteria->add(GraphCategoryPeer::CATEGORYID, $obj->getId());
