...
/**
 * Base class that represents a row from the 'MER_relationshipActiveQuestion' table.
 *
 * 
 *
 * @package    propel.generator.mer.classes.om
 */
abstract class BaseRelationshipActiveQuestion extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'RelationshipActiveQuestionPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        RelationshipActiveQuestionPeer
	 */
	 ...
	 * @return     RelationshipActiveQuestion The current object (for fluent API support)
	 */
	public function setActor1id($v)
	{
		...
		if ($this->actor1id !== $v) {
			$this->actor1id = $v;
			$this->modifiedColumns[] = RelationshipActiveQuestionPeer::ACTOR1ID;
		}
	...
	public function setActor2id($v)
	{
		...
		if ($this->actor2id !== $v) {
			$this->actor2id = $v;
			$this->modifiedColumns[] = RelationshipActiveQuestionPeer::ACTOR2ID;
		}
	...
	public function setQuestionid($v)
	{
		...
		if ($this->questionid !== $v) {
			$this->questionid = $v;
			$this->modifiedColumns[] = RelationshipActiveQuestionPeer::QUESTIONID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = RelationshipActiveQuestionPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating RelationshipActiveQuestion object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = RelationshipActiveQuestionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				RelationshipActiveQuestionQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				RelationshipActiveQuestionPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += RelationshipActiveQuestionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RelationshipActiveQuestionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RelationshipActiveQuestionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['RelationshipActiveQuestion'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['RelationshipActiveQuestion'][serialize($this->getPrimaryKey())] = true;
		$keys = RelationshipActiveQuestionPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RelationshipActiveQuestionPeer::ACTOR1ID)) $criteria->add(RelationshipActiveQuestionPeer::ACTOR1ID, $this->actor1id);
		if ($this->isColumnModified(RelationshipActiveQuestionPeer::ACTOR2ID)) $criteria->add(RelationshipActiveQuestionPeer::ACTOR2ID, $this->actor2id);
		if ($this->isColumnModified(RelationshipActiveQuestionPeer::QUESTIONID)) $criteria->add(RelationshipActiveQuestionPeer::QUESTIONID, $this->questionid);
	...
	{
		$criteria = new Criteria(RelationshipActiveQuestionPeer::DATABASE_NAME);
		$criteria->add(RelationshipActiveQuestionPeer::ACTOR1ID, $this->actor1id);
		$criteria->add(RelationshipActiveQuestionPeer::ACTOR2ID, $this->actor2id);
		$criteria->add(RelationshipActiveQuestionPeer::QUESTIONID, $this->questionid);
	...
	{
		return (null === $this->getActor1id()) && (null === $this->getActor2id()) && (null === $this->getQuestionid());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RelationshipActiveQuestion (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RelationshipActiveQuestion Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     RelationshipActiveQuestionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RelationshipActiveQuestionPeer();
		}
		return self::$peer;
	}
	...
	public function setActorRelatedByActor1id(Actor $v = null)
	{
		...
		if ($v !== null) {
			$v->addRelationshipActiveQuestionRelatedByActor1id($this);
		}
	...
	public function getActorRelatedByActor1id(PropelPDO $con = null)
	{
		if ($this->aActorRelatedByActor1id === null && ($this->actor1id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aActorRelatedByActor1id->addRelationshipActiveQuestionsRelatedByActor1id($this);
			 */
		}
	...
	public function setActorRelatedByActor2id(Actor $v = null)
	{
		...
		// If this object has already been added to the Actor object, it will not be re-added.
		if ($v !== null) {
			$v->addRelationshipActiveQuestionRelatedByActor2id($this);
		}
	...
	public function getActorRelatedByActor2id(PropelPDO $con = null)
	{
		if ($this->aActorRelatedByActor2id === null && ($this->actor2id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aActorRelatedByActor2id->addRelationshipActiveQuestionsRelatedByActor2id($this);
			 */
		}
	...
	public function setQuestion(Question $v = null)
	{
		...
		if ($v !== null) {
			$v->addRelationshipActiveQuestion($this);
		}
	...
	public function getQuestion(PropelPDO $con = null)
	{
		if ($this->aQuestion === null && ($this->questionid !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aQuestion->addRelationshipActiveQuestions($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(RelationshipActiveQuestionPeer::DEFAULT_STRING_FORMAT);
	}
...
} // BaseRelationshipActiveQuestion
