...
/**
 * Base class that represents a row from the 'MER_graphCategory' table.
 *
 * Graficos
 *
 * @package    propel.generator.mer.classes.om
 */
abstract class BaseGraphCategory extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'GraphCategoryPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        GraphCategoryPeer
	 */
	 ...
	 * @return     GraphCategory The current object (for fluent API support)
	 */
	public function setGraphid($v)
	{
		...
		if ($this->graphid !== $v) {
			$this->graphid = $v;
			$this->modifiedColumns[] = GraphCategoryPeer::GRAPHID;
		}
	...
	public function setCategoryid($v)
	{
		...
		if ($this->categoryid !== $v) {
			$this->categoryid = $v;
			$this->modifiedColumns[] = GraphCategoryPeer::CATEGORYID;
		}
	...
	public function setJudgement($v)
	{
		...
		if ($this->judgement !== $v) {
			$this->judgement = $v;
			$this->modifiedColumns[] = GraphCategoryPeer::JUDGEMENT;
		}
	...
	public function setOld($v)
	{
		...
		if ($this->old !== $v) {
			$this->old = $v;
			$this->modifiedColumns[] = GraphCategoryPeer::OLD;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = GraphCategoryPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating GraphCategory object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = GraphCategoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				GraphCategoryPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += GraphCategoryPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = GraphCategoryPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = GraphCategoryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['GraphCategory'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['GraphCategory'][serialize($this->getPrimaryKey())] = true;
		$keys = GraphCategoryPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GraphCategoryPeer::GRAPHID)) $criteria->add(GraphCategoryPeer::GRAPHID, $this->graphid);
		if ($this->isColumnModified(GraphCategoryPeer::CATEGORYID)) $criteria->add(GraphCategoryPeer::CATEGORYID, $this->categoryid);
		if ($this->isColumnModified(GraphCategoryPeer::JUDGEMENT)) $criteria->add(GraphCategoryPeer::JUDGEMENT, $this->judgement);
		if ($this->isColumnModified(GraphCategoryPeer::OLD)) $criteria->add(GraphCategoryPeer::OLD, $this->old);
	...
	{
		$criteria = new Criteria(GraphCategoryPeer::DATABASE_NAME);
		$criteria->add(GraphCategoryPeer::GRAPHID, $this->graphid);
		$criteria->add(GraphCategoryPeer::CATEGORYID, $this->categoryid);
	...
	{
		return (null === $this->getGraphid()) && (null === $this->getCategoryid());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of GraphCategory (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     GraphCategory Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     GraphCategoryPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new GraphCategoryPeer();
		}
		return self::$peer;
	}
	...
	public function getGraphModel(PropelPDO $con = null)
	{
		if ($this->aGraphModel === null && ($this->graphid !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aGraphModel->addGraphCategorys($this);
			 */
		}
	...
	public function getCategory(PropelPDO $con = null)
	{
		if ($this->aCategory === null && ($this->categoryid !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aCategory->addGraphCategorys($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(GraphCategoryPeer::DEFAULT_STRING_FORMAT);
	}
