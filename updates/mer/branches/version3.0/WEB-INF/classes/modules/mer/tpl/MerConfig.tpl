...
<table width='100%' border='0' cellspacing="0" cellpadding='0'>
	...
	<tr>
		...
		<td><table width="100%" border='0' cellpadding='0' cellspacing="0">
				<tr>
					<td width="20"><a href="Main.php?do=actorsAdd"><img src="images/cubo_tit.gif" width="14" height="18" border='0'></a></td>
					<td><a href="Main.php?do=actorsAdd" class='seccion'>##43,Ingresar Actores##</a></td>
				</tr>
				<tr>
					<td width="20">&nbsp;</td>
