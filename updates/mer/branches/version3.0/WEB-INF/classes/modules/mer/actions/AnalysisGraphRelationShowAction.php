...
class AnalysisGraphRelationShowAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function AnalysisGraphRelationShowAction() {
		;
	}
	...
	*/
    ...
    $smarty->assign("section",$section);
		...
		$graphRelation = GraphRelationPeer::get($graphId);

		$actor1 = ActorPeer::get($graphRelation->getActor1Id());
    $actor2 = ActorPeer::get($graphRelation->getActor2Id());

    $questions = $graphRelation->getQuestions();
