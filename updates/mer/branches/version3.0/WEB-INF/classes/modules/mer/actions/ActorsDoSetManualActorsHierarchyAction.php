...
class ActorsDoSetManualActorsHierarchyAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function ActorsDoSetManualActorsHierarchyAction() {
		;
	}
	...
	*/
    ...
    $i=0;
		...
		header("Location: Main.php?do=actorsSetActorsHierarchy&cat=".$_POST["category"]."&manual=1");
		exit;
