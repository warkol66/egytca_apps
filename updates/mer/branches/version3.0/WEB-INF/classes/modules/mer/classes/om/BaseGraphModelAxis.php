...
/**
 * Base class that represents a row from the 'MER_graphModelAxis' table.
 *
 * Preguntas de los ejes de los graficos modelos
 *
 * @package    propel.generator.mer.classes.om
 */
abstract class BaseGraphModelAxis extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'GraphModelAxisPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        GraphModelAxisPeer
	 */
	 ...
	 * Function de la pregunta sobre el valor del eje
	 * @return     int
	 */
	 ...
	 * @return     GraphModelAxis The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = GraphModelAxisPeer::ID;
		}
	...
	public function setGraphid($v)
	{
		...
		if ($this->graphid !== $v) {
			$this->graphid = $v;
			$this->modifiedColumns[] = GraphModelAxisPeer::GRAPHID;
		}
	...
	public function setAxis($v)
	{
		...
		if ($this->axis !== $v) {
			$this->axis = $v;
			$this->modifiedColumns[] = GraphModelAxisPeer::AXIS;
		}
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = GraphModelAxisPeer::TYPE;
		}
	...
	public function setQuestionid($v)
	{
		...
		if ($this->questionid !== $v) {
			$this->questionid = $v;
			$this->modifiedColumns[] = GraphModelAxisPeer::QUESTIONID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->graphid = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->axis = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->type = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->questionid = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = GraphModelAxisPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating GraphModelAxis object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = GraphModelAxisPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				GraphModelAxisPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(GraphModelAxisPeer::ID) ) {
					...
					$affectedRows += GraphModelAxisPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = GraphModelAxisPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = GraphModelAxisPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['GraphModelAxis'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['GraphModelAxis'][$this->getPrimaryKey()] = true;
		$keys = GraphModelAxisPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setAxis($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GraphModelAxisPeer::ID)) $criteria->add(GraphModelAxisPeer::ID, $this->id);
		if ($this->isColumnModified(GraphModelAxisPeer::GRAPHID)) $criteria->add(GraphModelAxisPeer::GRAPHID, $this->graphid);
		if ($this->isColumnModified(GraphModelAxisPeer::AXIS)) $criteria->add(GraphModelAxisPeer::AXIS, $this->axis);
		if ($this->isColumnModified(GraphModelAxisPeer::TYPE)) $criteria->add(GraphModelAxisPeer::TYPE, $this->type);
		if ($this->isColumnModified(GraphModelAxisPeer::QUESTIONID)) $criteria->add(GraphModelAxisPeer::QUESTIONID, $this->questionid);
	...
	{
		$criteria = new Criteria(GraphModelAxisPeer::DATABASE_NAME);
		$criteria->add(GraphModelAxisPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of GraphModelAxis (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     GraphModelAxis Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     GraphModelAxisPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new GraphModelAxisPeer();
		}
		return self::$peer;
	}
	...
	public function getGraphModel(PropelPDO $con = null)
	{
		if ($this->aGraphModel === null && ($this->graphid !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aGraphModel->addGraphModelAxiss($this);
			 */
		}
	...
	public function getQuestion(PropelPDO $con = null)
	{
		if ($this->aQuestion === null && ($this->questionid !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aQuestion->addGraphModelAxiss($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(GraphModelAxisPeer::DEFAULT_STRING_FORMAT);
	}
