...
/**
 * Base static class for performing query and update operations on the 'MER_formSectionQuestion' table.
 *
 * 
 *
...
abstract class BaseQuestionPeer {
	...
	const TABLE_NAME = 'MER_formSectionQuestion';

	/** the related Propel class for this table */
	const OM_CLASS = 'Question';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'mer.classes.Question';
	...
	const ID = 'MER_formSectionQuestion.ID';

	/** the column name for the SECTIONID field */
	const SECTIONID = 'MER_formSectionQuestion.SECTIONID';

	/** the column name for the TYPE field */
	const TYPE = 'MER_formSectionQuestion.TYPE';

	/** the column name for the QUESTION field */
	const QUESTION = 'MER_formSectionQuestion.QUESTION';

	/** the column name for the POSITION field */
	const POSITION = 'MER_formSectionQuestion.POSITION';

	/** the column name for the UNIT field */
	const UNIT = 'MER_formSectionQuestion.UNIT';

	/** the column name for the ANALYSIS field */
	const ANALYSIS = 'MER_formSectionQuestion.ANALYSIS';

	/** the column name for the LABEL field */
	const LABEL = 'MER_formSectionQuestion.LABEL';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Sectionid', 'Type', 'Question', 'Position', 'Unit', 'Analysis', 'Label', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'sectionid', 'type', 'question', 'position', 'unit', 'analysis', 'label', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::SECTIONID, self::TYPE, self::QUESTION, self::POSITION, self::UNIT, self::ANALYSIS, self::LABEL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SECTIONID', 'TYPE', 'QUESTION', 'POSITION', 'UNIT', 'ANALYSIS', 'LABEL', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'sectionId', 'type', 'question', 'position', 'unit', 'analysis', 'label', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Sectionid' => 1, 'Type' => 2, 'Question' => 3, 'Position' => 4, 'Unit' => 5, 'Analysis' => 6, 'Label' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'sectionid' => 1, 'type' => 2, 'question' => 3, 'position' => 4, 'unit' => 5, 'analysis' => 6, 'label' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SECTIONID => 1, self::TYPE => 2, self::QUESTION => 3, self::POSITION => 4, self::UNIT => 5, self::ANALYSIS => 6, self::LABEL => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SECTIONID' => 1, 'TYPE' => 2, 'QUESTION' => 3, 'POSITION' => 4, 'UNIT' => 5, 'ANALYSIS' => 6, 'LABEL' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'sectionId' => 1, 'type' => 2, 'question' => 3, 'position' => 4, 'unit' => 5, 'analysis' => 6, 'label' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(QuestionPeer::SECTIONID);
			$criteria->addSelectColumn(QuestionPeer::TYPE);
			$criteria->addSelectColumn(QuestionPeer::QUESTION);
			$criteria->addSelectColumn(QuestionPeer::POSITION);
			$criteria->addSelectColumn(QuestionPeer::UNIT);
			$criteria->addSelectColumn(QuestionPeer::ANALYSIS);
			$criteria->addSelectColumn(QuestionPeer::LABEL);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.SECTIONID');
			$criteria->addSelectColumn($alias . '.TYPE');
			$criteria->addSelectColumn($alias . '.QUESTION');
			$criteria->addSelectColumn($alias . '.POSITION');
			$criteria->addSelectColumn($alias . '.UNIT');
			$criteria->addSelectColumn($alias . '.ANALYSIS');
	...
	/**
	 * Method to invalidate the instance pool of all tables related to MER_formSectionQuestion
	 * by a foreign key with ON DELETE CASCADE
	 */
	public static function clearRelatedInstancePool()
	{
		// Invalidate objects in QuestionOptionPeer instance pool, 
		...
		// Invalidate objects in GraphRelationQuestionPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
	...
	/**
	 * Returns the number of rows matching criteria, joining the related FormSection table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinFormSection(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(QuestionPeer::SECTIONID, FormSectionPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Question objects pre-filled with their FormSection objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinFormSection(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = FormSectionPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = FormSectionPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					...
					FormSectionPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded

				// Add the $obj1 (Question) to $obj2 (FormSection)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		FormSectionPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + FormSectionPeer::NUM_HYDRATE_COLUMNS;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined FormSection rows

			$key2 = FormSectionPeer::getPrimaryKeyHashFromRow($row, $startcol2);
			if ($key2 !== null) {
				$obj2 = FormSectionPeer::getInstanceFromPool($key2);
				if (!$obj2) {
				...
				// Add the $obj1 (Question) to the collection in $obj2 (FormSection)
				$obj2->addQuestion($obj1);
	...
	/**
	 * Method to DELETE all rows from the MER_formSectionQuestion table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related QuestionOption objects
			$criteria = new Criteria(QuestionOptionPeer::DATABASE_NAME);
			
			$criteria->add(QuestionOptionPeer::QUESTIONID, $obj->getId());
			$affectedRows += QuestionOptionPeer::doDelete($criteria, $con);

			// delete related Answer objects
			$criteria = new Criteria(AnswerPeer::DATABASE_NAME);
			
			$criteria->add(AnswerPeer::QUESTIONID, $obj->getId());
			...
			$criteria->add(GraphModelAxisPeer::QUESTIONID, $obj->getId());
			$affectedRows += GraphModelAxisPeer::doDelete($criteria, $con);

			// delete related GraphRelationQuestion objects
			$criteria = new Criteria(GraphRelationQuestionPeer::DATABASE_NAME);
			
			$criteria->add(GraphRelationQuestionPeer::QUESTIONID, $obj->getId());
			$affectedRows += GraphRelationQuestionPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
