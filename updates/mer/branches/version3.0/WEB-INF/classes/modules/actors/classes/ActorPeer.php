...
class ActorPeer extends BaseActorPeer {
	...
	*/
	function getActorsWithNoCategory() {
		$cond = new Criteria();
		$cond->add(ActorPeer::CATEGORYID, null);
		$cond->add(ActorPeer::ACTIVE, 1);
		$objs = ActorPeer::doSelect($cond);
		return $objs;
	}
  ...
  function getUserActors($user){
  	$sql = "SELECT DISTINCT ".ActorPeer::TABLE_NAME.".* FROM ".UserGroupPeer::TABLE_NAME ." ,".GroupCategoryPeer::TABLE_NAME ." , ".ActorPeer::TABLE_NAME ." where ".UserGroupPeer::USERID ." = '".$user->getId()."' and ".UserGroupPeer::GROUPID ." = ".GroupCategoryPeer::GROUPID ." and ".GroupCategoryPeer::CATEGORYID ." = ".ActorPeer::CATEGORYID ;
