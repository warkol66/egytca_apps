|-if $section->getParentSectionId()-|
	<div style="display:inline"><a href="javascript:void(null)" onclick="document.getElementById('form_section_|-$section->getId()-|').style.display = 'inline'" title="##114,Editar##"><img src="images/clear.png" class="icon iconEdit" /></a>
		<form method='POST' action="Main.php?do=profilesFormQuestionDoEdit&delete=1&sectionId=|-$section->getId()-|&id=|-$form->getId()-|#edit" name='formsection|-$section->getId()-|' style="display:inline">
...
<ul>|-foreach from=$section->getQuestionsOrdered() item=question-|
	<li>
		<div style="display:inline"><a href="Main.php?do=profilesFormQuestionEdit&edit=1&questionId=|-$question->getId()-|&id=|-$form->getId()-|#edit" title="##114,Editar##"><img src="images/clear.png" class="icon iconEdit" /></a>
			<form  method='POST' action="Main.php?do=profilesFormQuestionDoEdit&delete=1&questionId=|-$question->getId()-|&id=|-$form->getId()-|#edit"  name='formquestion|-$question->getId()-|' style="display:inline">
