|-if $section->getParentSectionId()-|
	<div style="display:inline"><a href="javascript:void(null)" onclick="document.getElementById('form_section_|-$section->getId()-|').style.display = 'inline'" title="##114,Editar##"><img src="images/clear.png" class="icon iconEdit" /></a>
		<form method='POST' action="Main.php?do=profilesFormDoEdit&delete=1&sectionId=|-$section->getId()-|&form=|-$form->getId()-|#edit" name='formsection|-$section->getId()-|' style="display:inline">
...
<ul>|-foreach from=$section->getQuestionsOrder() item=question-|
	<li>
		<div style="display:inline"><a href="Main.php?do=profilesFormEdit&edit=1&questionId=|-$question->getId()-|&form=|-$form->getId()-|#edit" title="##114,Editar##"><img src="images/clear.png" class="icon iconEdit" /></a>
			<form  method='POST' action="Main.php?do=profilesFormDoEdit&delete=1&questionId=|-$question->getId()-|&form=|-$form->getId()-|#edit"  name='formquestion|-$question->getId()-|' style="display:inline">
