...
/**
 * Base static class for performing query and update operations on the 'MER_document' table.
 *
...
abstract class BaseDocumentPeer {
	...
	const TABLE_NAME = 'MER_document';

	/** the related Propel class for this table */
	const OM_CLASS = 'Document';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'documents.classes.Document';
	...
	const FILENAME = 'MER_document.FILENAME';

	/** the column name for the REALFILENAME field */
	const REALFILENAME = 'MER_document.REALFILENAME';

	/** the column name for the DATE field */
	const DATE = 'MER_document.DATE';

	/** the column name for the CATEGORYID field */
	const CATEGORYID = 'MER_document.CATEGORYID';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'MER_document.DESCRIPTION';

	/** the column name for the DOCUMENT_DATE field */
	const DOCUMENT_DATE = 'MER_document.DOCUMENT_DATE';
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(DocumentPeer::FILENAME);
			$criteria->addSelectColumn(DocumentPeer::REALFILENAME);
			$criteria->addSelectColumn(DocumentPeer::DATE);
			$criteria->addSelectColumn(DocumentPeer::CATEGORYID);
			...
			$criteria->addSelectColumn($alias . '.REALFILENAME');
	...
	/**
	 * Method to invalidate the instance pool of all tables related to MER_document
	...
	public static function doCountJoinCategory(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(DocumentPeer::CATEGORYID, CategoryPeer::ID, $join_behavior);
	...
	/**
	 * Method to DELETE all rows from the MER_document table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
