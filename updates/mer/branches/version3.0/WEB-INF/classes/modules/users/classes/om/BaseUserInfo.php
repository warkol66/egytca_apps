...
abstract class BaseUserInfo extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = UserInfoPeer::NUM_HYDRATE_COLUMNS.
	...
	{
		if (isset($alreadyDumpedObjects['UserInfo'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['UserInfo'][$this->getPrimaryKey()] = true;
	...
	{
		return (string) $this->exportTo(UserInfoPeer::DEFAULT_STRING_FORMAT);
	}
