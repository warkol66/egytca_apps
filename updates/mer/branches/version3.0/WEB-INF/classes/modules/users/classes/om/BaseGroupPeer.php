...
abstract class BaseGroupPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Created', 'Updated', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'created', 'updated', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CREATED, self::UPDATED, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'CREATED', 'UPDATED', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'created', 'updated', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Created' => 2, 'Updated' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'created' => 2, 'updated' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CREATED => 2, self::UPDATED => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'CREATED' => 2, 'UPDATED' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'created' => 2, 'updated' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
