...
<form method='post' action='Main.php?do=usersDoEdit'>
	...
	<table class='tableTdBorders' cellpadding='5' cellspacing='1' width='60%'>
		<tr>
			<td nowrap="nowrap" class='titulodato1'>##162,Identificación de Usuario##</td>
			<td><input name='username' type='text'  class='textodato' value='|-if $accion eq "edicion"-||-$currentUser->getUsername()-||-/if-|' size="70" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name='pass' type='password' class='textodato' value='' size="50" /></td>
		</tr>
		<tr>
			<td class='titulodato1'>##166,Repetir Contraseña##</td>
			<td><input name='pass2' type='password' class='textodato' value='' size="50" /></td>
		</tr>
		<tr>
...
<table class='tableTdBorders' cellpadding='5' cellspacing='1' width='100%'>
	...
	<tr>
		<td class='cellboton' colspan='4'><form action='Main.php' method='get'>
				...
				<input type='submit' value='##173,Nuevo Usuario##' />
			</form></td>
	</tr>
	|-else-|
	<tr>
		<td class='cellboton' colspan='4'><input type='submit' value='##173,Nuevo Usuario##' onClick="return alert('Todas las licencias se encuentran en uso. Si desea dar de alta un nuevo usuario debe eliminar alguno de los existentes.');"/></td>
	</tr>
	|-/if-|
</table>
<br />
