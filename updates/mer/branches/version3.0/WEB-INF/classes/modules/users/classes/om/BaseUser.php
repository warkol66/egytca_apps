...
abstract class BaseUser extends BaseObject  implements Persistent
{
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
	{
		...
		if ($includeForeignObjects) {
			...
			if (null !== $this->singleUserInfo) {
				$result['UserInfo'] = $this->singleUserInfo->toArray($keyType, $includeLazyLoadColumns, $alreadyDumpedObjects, true);
			}
	...
	public function clearAllReferences($deep = false)
	{
		...
		if ($this->singleUserInfo instanceof PropelCollection) {
			$this->singleUserInfo->clearIterator();
		}
		$this->singleUserInfo = null;
