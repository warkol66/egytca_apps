...
abstract class BaseUserPeer {
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'password', 'active', 'created', 'updated', 'levelid', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USERNAME, self::PASSWORD, self::ACTIVE, self::CREATED, self::UPDATED, self::LEVELID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'PASSWORD', 'ACTIVE', 'CREATED', 'UPDATED', 'LEVELID', ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'active' => 3, 'created' => 4, 'updated' => 5, 'levelid' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERNAME => 1, self::PASSWORD => 2, self::ACTIVE => 3, self::CREATED => 4, self::UPDATED => 5, self::LEVELID => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'PASSWORD' => 2, 'ACTIVE' => 3, 'CREATED' => 4, 'UPDATED' => 5, 'LEVELID' => 6, ),
