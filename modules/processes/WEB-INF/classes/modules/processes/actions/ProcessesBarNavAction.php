...
class ProcessesBarNavAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function ProcessesBarNavAction() {
		;
	}
	...
	*/
	function execute($mapping, $form, &$request, &$response) {
		...
		$processes = ProcessPeer::getAllByObjective($objectiveId,$dependencyId);
		$onTime = array();
		$delayed = array();
		$late = array();
		$labels = array();
		...
		$graph->subsubtitle->Set(Common::getTranslation(ProcessPeer::ITEM_NAME,$module));
