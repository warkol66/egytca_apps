    ...
    <li id="regionListItem|-$region->getId()-|">
      <form  method="post"> 
        ...
        <input type="hidden" name="regionId"  value="|-$region->getId()-|" /> 
			  <input type="button" value="Eliminar" title="Eliminar" onClick="if (confirm('¿Seguro que desea eliminar el vínculo con la región?')){deleteRegionFromProject(this.form)}; return false" class="buttonImageDelete" /> 
