...
<h3>Proyectos</h3>
		...
		|-assign var=colorsCount value=$project->getActivitiesByStatusColorCountAssoc()-|
			<tr>
				<td>|-$project->getObjectiveName()-|</td>
				...
				<td nowrap>|-$project->getgoalExpirationDate()|date_format:"%d-%m-%Y"-|</td>
				<td align="center">|-if $project->getfinished() eq 1-|Si|-else-|No|-/if-|</td>
