...
<div id="div_regions">
	...
	<table border="0" cellpadding="5" cellspacing="0"  class='tableTdBorders' id="tabla-regions">
        ...
        <option value="|-$typeKey-|" |-if $typeKey eq $filters.type-|selected="selected" |-/if-|>|-$type-|</option> 
			...
			<tr>
				 <th colspan="6" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=regionsEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addNew">Agregar Región</a></div></th>
			</tr>
			...
			<tr>
				...
				<td nowrap>
					...
					<form action="Main.php" method="post" style="display:inline;">
						...
						<input type="hidden" name="id" value="|-$region->getid()-|" />
						<input type="submit" name="submit_go_delete_region" value="Borrar" onclick="return confirm('Seguro que desea eliminar el barrio?')" class="buttonImageDelete" />
					</form>
				</td>
			</tr>
		|-/foreach-|						
