...
class NewslettersSchedulesEditAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function NewslettersSchedulesEditAction() {
		;
	}
	...
	*/
    ...
    if ( !empty($_GET["id"]) ) {
			...
			$newsletterschedule = NewsletterSchedulePeer::get($_GET["id"]);
			...
			//voy a crear un newsletterschedule nuevo
