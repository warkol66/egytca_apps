...
<div id="div_objectives">
	...
	<table id="tabla-objectives" class='tableTdBorders' cellpadding='5' cellspacing='0' width='100%'>
		...
		<tr>
			...
			<tr>
				 <th colspan="|-if $moduleConfig.useDependencies.value =="YES"-|5|-else-|4|-/if-|" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=objectivesStrategicObjectivesEdit" class="addNew">Agregar ##objectives,2,Objetivo Etratégico##</a></div></th>
			</tr>
		...
		|-/if-|
			<tr>
				<th colspan="|-if $moduleConfig.useDependencies.value =="YES"-|5|-else-|4|-/if-|" class="thFillTitle">|-if $objectives|@count gt 5-|
				  <div class="rightLink"><a href="Main.php?do=objectivesStrategicObjectivesEdit" class="addNew">Agregar ##objectives,2,Objetivo Etratégico##</a></div>|-/if-|</th>
			</tr>
		</tbody>
	</table>
</div>
