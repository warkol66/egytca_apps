...
class ObjectivesStrategicObjectivesDoDeleteAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function ObjectivesStrategicObjectivesDoDeleteAction() {
		;
	}
	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
		...
		$module = "Objectives";
    		...
    		$objective = StrategicObjectivePeer::get($_POST["id"]);
