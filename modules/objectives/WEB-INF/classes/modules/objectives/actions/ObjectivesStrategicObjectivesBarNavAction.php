...
class ObjectivesStrategicObjectivesBarNavAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function ObjectivesStrategicObjectivesBarNavAction() {
		;
	}
	...
	*/
	function execute($mapping, $form, &$request, &$response) {
		...
		if (!empty($_GET["page"])) {
			...
			$objectives = StrategicObjectivePeer::getAll($dependencyId);
		...
		$graph->subtitle->Set(Common::getTranslation(StrategicObjectivePeer::ITEM_NAME,'tablero'));
