...
<script type="text/javascript">
  ...
  <script type="text/javascript" src="areaedit/ddt/ddt.js"></script>
  ...
  <script type="text/javascript" src="areaedit/htmlarea.js"></script>
  ...
  <script type="text/javascript">
   ...
   var areaedit_plugins = null;
	...
	startupDDT._ddt( "sample.html", "120", "Setting up areaedit_init()" );
	...
	*/
	...
	areaedit_init = function()
		...
		startupDDT._ddt( "sample.html", "76", "areaedit_init called from window.onload handler for news_upd.php" );
...
//       'Linker',
      ...
      // This loads the plugins. We're using a very minimal list
		...
		// linker.js and F-manager.js) in the "background". The second parameter
	   ...
	   startupDDT._ddt( "sample.html", "92", "calling HTMLArea.loadplugins()" );
       ...
       *************************************************************************/
  	    ...
  	    startupDDT._ddt( "sample.html", "119", "calling HTMLArea.Config()" );
      ...
      startupDDT._ddt( "sample.html", "140", "calling HTMLArea.makeEditors()" );
       ...
       ************************************************************************/
       ...
       areaedit_editors.TextArea1.config.height = 300;
      ...
      startupDDT._ddt( "sample.html", "600", "calling HTMLArea.startEditors()" );
