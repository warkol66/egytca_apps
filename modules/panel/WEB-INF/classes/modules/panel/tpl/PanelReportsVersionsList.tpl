...
|-if !$result-|			<tr>
				 <th colspan="4" class="thFillTitle">
				 	<div class="rightLink"><a href="Main.php?do=panelReportsVersionsEdit" class="addNew">Agregar Versión</a></div>
				</th>
			</tr>
|-/if-|			<tr class="thFillTitle">
			...
			<tr>
				...
				<td nowrap>
					...
					<form action="Main.php" method="get" style="display:inline;">
						...
						<input type="submit" name="submit_go_edit_report_version" value="Editar" title="Editar" class="buttonImageEdit" />
					</form>
					<form action="Main.php" method="get" style="display:inline;">
					...
					<form action="Main.php" method="post" style="display:inline;">
						...
						<input type="hidden" name="versionId" value="|-$version->getId()-|" />
						<input type="submit" name="submit_go_delete_version" value="Borrar" onclick="return confirm('Seguro que desea eliminar completamente la versión?')" class="buttonImageDelete" />
					</form>
				</td>
			</tr>
			|-/foreach-|						
		...
		|-/if-|
|-if !$result-|				<tr>
				 <th colspan="4" class="thFillTitle">|-if $versions|@count gt 5-|<div class="rightLink"><a href="Main.php?do=panelReportsVersionsEdit" class="addNew">Agregar Versión</a></div>|-/if-|</th>
			</tr>|-/if-|
		|-/if-|
		</tbody>
	</table>
