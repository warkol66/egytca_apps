...
<thead> |-if !$result-|		
		<tr>
			...
			<tr>
				 <th colspan="6" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=panelMissionEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addNew">Agregar Misión</a></div></th>
			</tr>
|-/if-|
    ...
    |-/foreach-|</td> 
		...
		|-/if-|
			<tr>
				 <th colspan="6" class="thFillTitle">|-if $missions|@count gt 5-|<div class="rightLink"><a href="Main.php?do=panelMissionEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addNew">Agregar Misión</a></div>|-/if-|</th>
			</tr>
		|-/if-|
		</tbody> 
		 </table> 
