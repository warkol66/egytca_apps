				...
				<tr>
					...
					<td nowrap>
						...
						<form action="Main.php" method="post" style="display:inline;">
							...
							<input type="submit" name="submit_go_resend" title="Reenviar" value="Reenviar" onclick="return confirm('¿Seguro que desea reenviar esta notifiación?')" class="buttonImageSendMultiple" />
						</form>
					</td>
				</tr>
			|-/foreach-|						
