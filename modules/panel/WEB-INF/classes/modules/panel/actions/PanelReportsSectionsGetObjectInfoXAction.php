...
class PanelReportsSectionsGetObjectInfoXAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function PanelReportsSectionsGetObjectInfoXAction() {
		;
	}
	...
	function execute($mapping, $form, &$request, &$response) {
		...
		$objectType = $_POST['sectionData']['objectType'];
		$objectId = $_POST['sectionData']['objectId'];
