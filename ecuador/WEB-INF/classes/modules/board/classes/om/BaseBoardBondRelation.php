...
/**
 * Base class that represents a row from the 'board_bondRelation' table.
 *
 * Asociacion entre Challenges y Compromisos
 *
 * @package    propel.generator.board.classes.om
 */
abstract class BaseBoardBondRelation extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'BoardBondRelationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BoardBondRelationPeer
     */
     ...
     * @return BoardBondRelation The current object (for fluent API support)
     */
    public function setChallengeid($v)
    {
        ...
        if ($this->challengeid !== $v) {
            $this->challengeid = $v;
            $this->modifiedColumns[] = BoardBondRelationPeer::CHALLENGEID;
        }
    ...
    public function setBondid($v)
    {
        ...
        if ($this->bondid !== $v) {
            $this->bondid = $v;
            $this->modifiedColumns[] = BoardBondRelationPeer::BONDID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->challengeid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->bondid = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = BoardBondRelationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BoardBondRelation object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BoardBondRelationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BoardBondRelationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BoardBondRelationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BoardBondRelationPeer::CHALLENGEID)) {
            $modifiedColumns[':p' . $index++]  = '`CHALLENGEID`';
        }
        if ($this->isColumnModified(BoardBondRelationPeer::BONDID)) {
            $modifiedColumns[':p' . $index++]  = '`BONDID`';
        }

        $sql = sprintf(
            'INSERT INTO `board_bondRelation` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BoardBondRelationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BoardBondRelationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BoardBondRelation'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BoardBondRelation'][serialize($this->getPrimaryKey())] = true;
        $keys = BoardBondRelationPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getChallengeid(),
            $keys[1] => $this->getBondid(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setBondid($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BoardBondRelationPeer::CHALLENGEID)) $criteria->add(BoardBondRelationPeer::CHALLENGEID, $this->challengeid);
        if ($this->isColumnModified(BoardBondRelationPeer::BONDID)) $criteria->add(BoardBondRelationPeer::BONDID, $this->bondid);
    ...
    {
        $criteria = new Criteria(BoardBondRelationPeer::DATABASE_NAME);
        $criteria->add(BoardBondRelationPeer::CHALLENGEID, $this->challengeid);
        $criteria->add(BoardBondRelationPeer::BONDID, $this->bondid);
    ...
    {
        $pks = array();
        $pks[0] = $this->getChallengeid();
        $pks[1] = $this->getBondid();
    ...
    {
        $this->setChallengeid($keys[0]);
        $this->setBondid($keys[1]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getChallengeid()) && (null === $this->getBondid());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of BoardBondRelation (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BoardBondRelation Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BoardBondRelationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BoardBondRelationPeer();
        }
    ...
    public function getBoardChallenge(PropelPDO $con = null)
    {
        if ($this->aBoardChallenge === null && ($this->challengeid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBoardChallenge->addBoardBondRelations($this);
             */
        }
    ...
    public function getBoardBond(PropelPDO $con = null)
    {
        if ($this->aBoardBond === null && ($this->bondid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBoardBond->addBoardBondRelations($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BoardBondRelationPeer::DEFAULT_STRING_FORMAT);
    }
