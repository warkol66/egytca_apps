     ...
     <td>
         ...
         |-/foreach-|
				 |-/if-|
					...
					|-if $allThisDayEvents ne ''-||-assign var=closeText value="Cerrar"|multilang_get_translation:"common"-||-assign var=caption value="Información del Evento"|multilang_get_translation:"calendar"-|
