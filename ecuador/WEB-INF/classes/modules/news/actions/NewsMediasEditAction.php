...
class NewsMediasEditAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function NewsMediasEditAction() {
		;
	}
	...
	*/
    ...
    if ( !empty($_GET["id"]) ) {
			//voy a editar un newsmedia

			$newsmedia = NewsMediaPeer::get($_GET["id"]);
			...
			//voy a crear un newsmedia nuevo
