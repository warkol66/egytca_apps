...
<form method="post" action="Main.php">
    ...
    <legend>Afiliado</legend>
		...
		<p>
			...
			<input type="button" onClick='location.href="Main.php?do=affiliatesUsersLevelsList|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($page)-|&page=|-$page-||-/if-|"' value="##104,Regresar##" />
		</p>
	</fieldset>
</form>
