...
<table width='100%' border="0" cellpadding='5' cellspacing='0' class='tableTdBorders'>
	...
	|-if "affiliatesContractorsEdit"|security_has_access-|<tr>
		<th colspan="3"><div class="rightLink"><a href="Main.php?do=affiliatesContractorsEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addLink">Agregar Contratista</a></div></th>
	</tr>|-/if-|
