...
INSERT INTO `actionLogs_label` (`action`, `label`, `language`, `forward`) VALUES ( 'UsersPasswordRecoveryDoRequest', 'Solicitud de recuperación de contraseña exitosa','esp','success');
INSERT INTO `actionLogs_label` (`action`, `label`, `language`, `forward`) VALUES ( 'UsersPasswordRecoveryDoRequest', 'No se pudo procesar la solicitud','esp','failure');
INSERT INTO `actionLogs_label` (`action`, `label`, `language`, `forward`) VALUES ( 'UsersDoLogout', 'Fin de sesión exitoso','esp','success');
INSERT INTO `actionLogs_label` (`action`, `label`, `language`, `forward`) VALUES ( 'UsersPasswordDoChange', 'Cambio de contraseña exitoso','esp','success');
INSERT INTO `actionLogs_label` (`action`, `label`, `language`, `forward`) VALUES ( 'UsersPasswordDoChange', 'Cambio de contraseña exitoso','esp','changePassword');
INSERT INTO `actionLogs_label` (`action`, `label`, `language`, `forward`) VALUES ( 'UsersPasswordDoChange', 'No se pudo modificar la contraseña','esp','failure');
