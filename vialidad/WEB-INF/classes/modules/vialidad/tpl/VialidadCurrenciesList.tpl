...
<div id="div_currencies"> 
	|-if $message eq "deleted_ok"-|
		<div id="deleted_message" class="successMessage">Moneda eliminada correctamente</div>
|-elseif $message eq "not_deleted"-|
	<div  class="errorMessage">Ha ocurrido un error al intentar eliminar la Moneda. No se pueden eliminar Monedas que se encuentren en uso.</div>
|-/if-|
	...
	<table id="table_currencies" class='tableTdBorders' cellpadding='5' cellspacing='0' width='100%'> 
		...
		<tr>
			<th colspan="3" class="thFillTitle">
				<div class="rightLink">
					<a href="javascript:void(null);" onclick="toggleInput('addInput1', 'addLink1'); return false;" id="addLink1" class="addLink">Agregar Moneda</a>
		...
		<tr>
			<th colspan="3" class="thFillTitle">
				<div class="rightLink">
					<a href="javascript:void(null);" onclick="toggleInput('addInput2', 'addLink2'); return false;" id="addLink2" class="addLink">Agregar Moneda</a>
