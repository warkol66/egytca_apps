...
<html>
<head>
|-block name="title"-|<title>|-if isset($module)-||-$module|multilang_get_translation:"common"-| - |-/if-||-$parameters.siteName-| |-if $SESSION.supervisorUser-|#supervisor como: |-$SESSION.loginUser->getUsername()-| |-/if-|</title>|-/block-|
