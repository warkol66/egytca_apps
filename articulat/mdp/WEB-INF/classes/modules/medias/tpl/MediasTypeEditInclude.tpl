<script type="text/javascript" >
	function createActor(form) {
		...
		var myAjax = new Ajax.Updater('operationInfo',
					"Main.php?do=mediasTypeDoEditX",
					{
						method: 'post',
						parameters: { action: "mediasTypeDoEditX"},
						postBody: fields,
						evalScripts: true
					});
	...
	<form name="form_edit_type" id="form_edit_type" action="Main.php" method="post">
		<fieldset title="Formulario de edición de datos de un ##actors,2,Actor##">
			...
			<p>
				...
				<input type="button" id="button_edit_type" name="button_edit_type" title="Aceptar" value="Agregar nuevo" onClick="javascript:createActor(this.form)"/>
