    ...
    <li id="li_|-$tweet->getId()-|">
		<div class="tweet">
			<div class="twitterButtons">
				...
				<img src="images/clear.png" class="icon iconPlus" onClick='{new Ajax.Updater("resultDiv", "Main.php?do=twitterDoEditX", { method: "post", parameters: { id: "|-$tweet->getId()-|", "params[value]": "1"}, evalScripts: true})};$("resultDiv").innerHTML = "<span class=\"inProgress\">guardando tweet...</span>";' value="Valorar positivo" />
				<img src="images/clear.png" class="icon iconCollapse" onClick='{new Ajax.Updater("resultDiv", "Main.php?do=twitterDoEditX", { method: "post", parameters: { id: "|-$tweet->getId()-|", "params[value]": "3"}, evalScripts: true})};$("resultDiv").innerHTML = "<span class=\"inProgress\">guardando tweet...</span>";' value="Valorar negativo" />
