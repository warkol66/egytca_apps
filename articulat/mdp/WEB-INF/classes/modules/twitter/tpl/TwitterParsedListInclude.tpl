    ...
    <li id="li_|-$tweet->getId()-|">
		<div class="tweet">
			<div class="twitterButtons">
				...
				<img src="images/clear.png" class="icon iconActivate" onClick='{new Ajax.Updater("resultDiv", "Main.php?do=twitterDoEditX", { method: "post", parameters: { id: "|-$tweet->getId()-|", "params[value]": "2", "params[status]": "2", parsed: true}, evalScripts: true})};$("resultDiv").innerHTML = "<span class=\"inProgress\">guardando tweet...</span>";' value="Valorar neutro" />
