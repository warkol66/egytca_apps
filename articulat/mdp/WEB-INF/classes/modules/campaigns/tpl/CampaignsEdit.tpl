...
<fieldset>
	...
	<div id="div_tweets">
	|-include file="TwitterListX.tpl" twitterTweetColl=$acceptedTweets campaignid=$campaign->getId() tweetValues=$tweetValues tweetRelevances=$tweetRelevances tweetStatuses=$tweetStatuses matched=$matched embedded='true'-|
