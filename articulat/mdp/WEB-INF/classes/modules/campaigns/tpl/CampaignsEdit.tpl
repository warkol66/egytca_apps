...
<div id="div_campaign">
	<p>Ingrese los datos del Campaña</p>
		<p align="right"><a href="#" class="return" onClick="location.href='Main.php?do=campaignsList|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($page)-|&page=|-$page-||-/if-|'">Volver al listado</a> &nbsp;&nbsp; |-if !$campaign->isNew()-|<a class="importHeadlines" href="Main.php?do=headlinesParsedList&filters[campaignId]=|-$campaign->getId()-|">Obtener Titulares</a>&nbsp; &nbsp; <a class="report" href="Main.php?do=campaignsEdit&report=1&id=|-$campaign->getId()-|">Generar Reporte</a>|-/if-|
		</p>
	|-if $message eq "ok"-|
