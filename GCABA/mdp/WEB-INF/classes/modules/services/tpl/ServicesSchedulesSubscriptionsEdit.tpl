...
function showEntityFieldSelector(entityName) {
	var myAjax = new Ajax.Updater(
				...
				'Main.php?do=servicesSchedulesSubscriptionsGetEntityFields',
				{
					method: 'get',
...
<div id="div_scheduleSubscription">
	<p>Ingrese los datos del Suscripción a Agenda</p>
		<p><a href="#" onClick="location.href='Main.php?do=servicesSchedulesSubscriptionsList|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($page)-|&page=|-$page-||-/if-|'">Volver atras</a>
		</p>
	|-if $message eq "ok"-|
	...
	<form name="form_edit_scheduleSubscription" id="form_edit_scheduleSubscription" action="Main.php" method="post">
		<fieldset title="Formulario de edición de datos de un Suscripción a Schedulea">
			...
			<div id="entityFieldSelector">
				|-include file="ServicesSchedulesSubscriptionsEntityFieldSelectorInclude.tpl"-|
			</div>
				|-if $action eq 'edit'-|
			...
			<p>* Para agregar información sobre destinatarios debe guardar primero la suscripción a agenda. </p>
				|-/if-|
			<p>
				<input type="hidden" name="do" id="do" value="servicesSchedulesSubscriptionsDoEdit" />
				<input type="submit" id="button_edit_scheduleSubscription" name="button_edit_scheduleSubscription" title="Aceptar" value="Guardar" />
				<input type="button" id="cancel" name="cancel" title="Volver al listado" value="Volver al listado" onClick="location.href='Main.php?do=servicesSchedulesSubscriptionsList|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($page)-|&page=|-$page-||-/if-|'"/>
			</p>
		</fieldset>
	</form>
</div>
...
<div id="PartyAdding"> <span id="partieMsgField"></span> 
  <form method="post"> 
	...
	<p>
      <input type="hidden" name="do" id="do" value="servicesSchedulesSubscriptionsDoAddUserX" /> 
  ...
  <div id="detinataryList">
	|-include file="ServicesSchedulesSubscriptionsUsersInclude.tpl"-|
  </div>	
