<table width='60%' border="0" cellpadding='5' cellspacing='0' class='tableTdBorders' id="tabla-objectives">
	...
	|-foreach from=$result item=position name=for_positions-|	
		<tr>
			...
			<td width="2%" align="center" nowrap>|-if $position->countBrood() gt 0-|<a href="Main.php?do=planningTreeDivs&id=|-$position->getId()-|" class="icon iconNodes" title="ver arbol de objetivos">|-$position->getname()-|</a>|-/if-|
			</td>
		</tr>
	|-/foreach-|
	</tbody>
