...
class ProjectsActivitiesNavAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function ProjectsActivitiesNavAction() {
		;
	}
	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
		...
		if (!empty($_GET["status"])) {
			$method = "getActivities".$_GET["status"];
			$Activities = $project->$method();
		}
		else {
			$Activities = ProjectActivityPeer::getAllByProject($_GET['projectId'],$dependencyId);		
		}
