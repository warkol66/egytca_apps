...
<div id="div_projects">
	...
	<thead>
	<tr>
		<td colspan="9" class="tdSearch"><a href="javascript:void(null);" onClick='switch_vis("divSearch");' class="tdTitSearch">Buscar ##projects,5,proyectos##</a>
	...
	|-if $configModule->get("projects","useRegions")-|
      ...
      <select id="filters[priority]" name="filters[priority]" title="Prioridad"> 
			...
			|-html_options options=$priorityTypes selected=$filters.priority-|
      </select>	
			<label for="filters[visibility]">Visibilidad*</label>
      <select id="filters[visibility]" name="filters[visibility]" title="Visibilidad"> 
			<option value="0">Seleccione Visibilidad</option>
				|-section start=0 loop=10 name=for_visibility-|
        <option value="|-$smarty.section.for_visibility.iteration-|" |-$filters.visibility|selected:$smarty.section.for_visibility.iteration-|>|-$smarty.section.for_visibility.iteration-|</option> 
				|-/section-|
      </select>
      *y	superior	</p>
		...
		<tr class="thFillTitle">
			<th colspan="9"><div class="rightLink"><a href="Main.php?do=projectsEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addLink">Agregar ##projects,1,Proyecto##</a></div></th>
		</tr>
		<tr class="thFillTitle">
			<!--<th width="4%">Id</th>-->
	...
	<tbody>|-if $projects|@count eq 0-|
		<tr>
			 <td colspan="9">|-if isset($filters)-|No hay ##projects,2,Proyectos## que concuerden con la búsqueda|-else-|No hay ##projects,2,Proyectos## disponibles|-/if-|</td>
		</tr>
	|-else-|
		|-foreach from=$projects item=project name=for_projects-|
			...
			<!--	<td>|-$project->getid()-|</td>-->
				...
				<td><a href="Main.php?do=projectsActivitiesList&filters[projectId]=|-$project->getid()-|&filters[fromProjects]=true" title="Ver actividades del ##projects,4,proyecto##" class="follow">|-$project->getname()-|</a> |-if $project->getDescription() ne ""-|<a class="tooltipWide" href="#"><span>|-$project->getDescription()|nl2br-|</span><img src="images/icon_info.gif"></a>|-/if-|</td>
				<td>|-assign var=position value=$project->getPosition()-||-if !empty($position)-||-$position->getOwnerName()-| &#8212; |-assign var=tenure value=$position->getActiveTenure()-| |-if $tenure->getObject() != NULL-||-assign var=tenureObject value=$tenure->getObject()-||-$tenureObject->getName()-| |-$tenureObject->getSurname()-||-/if-||-/if-|</td>
				...
				<td nowrap="noWrap">
				|-if $configModule->get("projects","useDisbursements")-|
