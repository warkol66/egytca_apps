...
class Common {
	...
	*/
	...
	/**
	 * Obtiene el formato de fecha expresado como para un DatePicker a partir de la configuraciÃƒÂ³n local.
	 */
	...
	*/
	...
	/**
	* Encripta md5 propio del sistema para el sistema con particula añadida de seguridad
	*
	* @param $string string original
	* @return string encriptado con añadido de seguridad
	*/
	function md5($string) {
