...
<div id="div_positions_versions">
	...
	<table border="0" cellpadding="5" cellspacing="0"  class='tableTdBorders' id="tabla-positions-versions">
		<thead>
			<tr>
				 <th colspan="4" class="thFillTitle">
				 	<div class="rightLink"><a href="Main.php?do=positionsVersionsEdit" class="addLink">Agregar Versión</a></div>
				</th>
			</tr>
			...
			<tr>
				...
				<td nowrap>
					...
					<form action="Main.php" method="get" style="display:inline;">
						...
						<input type="submit" name="submit_go_edit_position_version" value="Editar" class="icon iconEdit" />
					</form>
				</td>
			</tr>
			|-/foreach-|						
		...
		|-/if-|
			<tr>
				 <th colspan="5" class="thFillTitle">|-if $versions|@count gt 5-|<div class="rightLink"><a href="Main.php?do=positionsVersionsEdit" class="addLink">Agregar Versión</a></div>|-/if-|</th>
			</tr>
		|-/if-|
		</tbody>
	</table>
