...
require_once("TableroCommuneObjective.php");

class TableroStrategicObjectivesDoAddCommuneToObjectiveXAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroStrategicObjectivesDoAddCommuneToObjectiveXAction() {
		;
	}
