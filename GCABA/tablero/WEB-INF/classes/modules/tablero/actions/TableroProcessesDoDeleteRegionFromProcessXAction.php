...
require_once("TableroRegionProcessPeer.php");

class TableroProcessesDoDeleteRegionFromProcessXAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroProcessesDoDeleteRegionFromProcessXAction() {
		;
	}
