...
class TableroMilestonesEditAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function TableroMilestonesEditAction() {
		;
	}
	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
    	...
    	if ( !empty($_GET["id"]) ) {
			//voy a editar un milestone

			$milestone = TableroMilestonePeer::get($_GET["id"]);
			if (Common::isAffiliatedUser() && (!$milestone->isOwner(Common::getAffiliatedId()))) {
			...
			//voy a crear un milestone nuevo
