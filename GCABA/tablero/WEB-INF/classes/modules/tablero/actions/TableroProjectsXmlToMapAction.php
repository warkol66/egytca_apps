...
class TableroProjectsXmlToMapAction extends BaseAction {

	// ----- Constructor ---------------------------------------------------- //

	function TableroProjectsXmlToMapAction() {
		;
	}
	...
	*/
	function execute($mapping, $form, &$request, &$response) {
		...
		$projects = TableroProjectPeer::getProjectsToMap($depdendencyObjs);
