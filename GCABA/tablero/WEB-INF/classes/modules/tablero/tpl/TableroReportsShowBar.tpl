...
<div > 
	...
	|-foreach from=$result item=dependency name=for_results-|
		...
		|-if ($level eq "objectives")-|
		    ...
		    <dd>
		    	<p> <img src="Main.php?do=tableroReportsPlotBar&delayed=|-$dependency->getCountObjectivesDelayed()-|&late=|-$dependency->getCountObjectivesLate()-|&onTime=|-$dependency->getCountObjectivesOnTime()-|"> 
		    	</p> 
		    </dd>
		|-else-|
      			...
      			|-if ($level eq "projects")-|
					<dd>Cantidad de Proyectos: |-$objective->getProjects()|@count-|</dd> 
      				...
      				<dd> 
        				...
        				<p> <img src="Main.php?do=tableroReportsPlotBar&delayed=|-$objective->getCountProjectsDelayed()-|&onTime=|-$objective->getCountProjectsOnTime()-|&late=|-$objective->getCountProjectsLate()-|"> </p> 
      				</dd> 
      				|-/foreach-|
      			|-else-|
	      			|-foreach from=$objective->getProjects() item=project name=for_projects-|
		      			...
		      			|-if ($level eq "milestones" or $level eq "indicatorsAndMilestones")-|
							<dd>
		        				<p> 
		        					<img src="Main.php?do=tableroReportsPlotBar&delayed=|-$project->getCountMilestonesDelayed()-|&onTime=|-$project->getCountMilestonesOnTime()-|&late=|-$project->getCountMilestonesLate()-|"> 
		        				</p> 
