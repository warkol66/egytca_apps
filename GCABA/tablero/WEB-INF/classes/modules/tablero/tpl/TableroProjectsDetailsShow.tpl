...
<div id="div_milestones">
	<table width='100%' border="0" cellpadding='5' cellspacing='0' class='tableTdBorders' id="tabla-milestones">
		<thead>
			...
			<tr>
				 <th colspan="5" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=tableroMilestonesEdit&projectId=|-$project->getId()-|&show=1" class="addLink">Agregar Hito al Proyecto</a></div></th>
			</tr>
			<tr>
...
<div id="div_indicators">
	<table width='100%' border="0" cellpadding='5' cellspacing='0'  class='tableTdBorders' id="tabla-indicators">
		<thead>
			...
			<tr>
				 <th colspan="7" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=tableroIndicatorsEdit&projectId=|-$project->getId()-|&show=1" class="addLink">Agregar Indicador al Proyecto</a></div></th>
			</tr>
			<tr>
