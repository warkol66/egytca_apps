...
require_once("DocumentObjectivePeer.php");

class ObjectivesStrategicObjectivesDoDeleteDocumentFromObjectiveXAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function ObjectivesStrategicObjectivesDoDeleteDocumentFromObjectiveXAction() {
		;
	}
