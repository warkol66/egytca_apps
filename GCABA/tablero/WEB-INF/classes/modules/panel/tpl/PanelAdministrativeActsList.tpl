...
<div id="div_administrativeActs"> 
	...
	<table id="tabla-administrativeActs" class='tableTdBorders' cellpadding='5' cellspacing='0' width='100%'> 
		...
		<tr>
			...
			<tr>
				 <th colspan="8" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=panelAdministrativeActsEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addLink">Agregar Acto Administrativo</a></div></th>
			</tr>
    ...
    |-/foreach-|</ul>|-/if-|
		...
		|-/if-|
			<tr>
				 <th colspan="8" class="thFillTitle">|-if $administrativeActs|@count gt 5-|<div class="rightLink"><a href="Main.php?do=panelAdministrativeActsEdit|-include file="FiltersRedirectUrlInclude.tpl" filters=$filters-||-if isset($pager) && ($pager->getPage() ne 1)-|&page=|-$pager->getPage()-||-/if-|" class="addLink">Agregar Acto Administrativo</a></div>|-/if-|</th>
			</tr>
		|-/if-|
		</tbody> 
		 </table> 
