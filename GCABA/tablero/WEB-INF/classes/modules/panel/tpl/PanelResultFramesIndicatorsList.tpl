...
<div id="div_resultFrameIndicators">
	...
	<table border="0" cellpadding="5" cellspacing="0"  class='tableTdBorders nestedTable' id="tabla-resultFrameIndicators">
        ...
        <option value="|-$typeKey-|" |-if $typeKey eq $filters.type-|selected="selected" |-/if-|>|-$type-|</option> 
			...
			<tr>
				 <th colspan="5" class="thFillTitle">
				 	<div class="rightLink"><a href="Main.php?do=panelResultFramesIndicatorsEdit" class="addLink">Agregar Indicador</a></div>
				</th>
			</tr>
		...
		|-/if-|
			<tr>
				 <th colspan="5" class="thFillTitle">|-if $resultFrameIndicators|@count gt 5-|<div class="rightLink"><a href="Main.php?do=panelResultFramesIndicatorsEdit" class="addLink">Agregar Indicador</a></div>|-/if-|</th>
			</tr>
		|-/if-|
		</tbody>
	</table>
