        ...
        <option value="|-$typeKey-|" |-if $typeKey eq $filters.type-|selected="selected" |-/if-|>|-$type-|</option> 
			...
			<tr>
				 <th colspan="5" class="thFillTitle">
				 	<div class="rightLink"><a href="Main.php?do=panelReportsSectionsEdit" class="addLink">Agregar Sección</a></div>
<!--					<div class="rightLink"><a href="#" onclick="$('positionsVersionEdit').show();return false;" class="addLink">Agregar Versión</a></div>
				...
				<tr class="nestedRow|-$reportSection->getLevel()-|">
					...
					<td nowrap>
						<form action="Main.php" method="get" style="display:inline;">
							...
							<input type="submit" name="submit_go_edit_section" value="Editar" class="icon iconEdit" />
						</form>
						<form action="Main.php" method="post" style="display:inline;">
							...
							<input type="hidden" name="id" value="|-$reportSection->getid()-|" />
							<input type="submit" name="submit_go_delete_section" value="Borrar" onclick="return confirm('Seguro que desea eliminar la sección?')" class="icon iconDelete" />
						</form>
		...
		|-/if-|
			<tr>
				 <th colspan="5" class="thFillTitle">|-if $reportSections|@count gt 5-|<div class="rightLink"><a href="Main.php?do=panelReportsSectionsEdit" class="addLink">Agregar Sección</a></div>|-/if-|</th>
			</tr>
		|-/if-|
		</tbody>
	</table>
