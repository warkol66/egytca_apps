		<tr> 
			...
			<td nowrap>
				|-if "planningMeasureUnitsEdit"|security_has_access-|
					<input type="hidden" name="do" value="planningMeasureUnitsEdit" />
				...
				|-/if-|
				|-if "planningMeasureUnitsDoDelete"|security_has_access-|
				<form action="Main.php" method="post" style="display:inline;">
					<input type="hidden" name="do" value="planningMeasureUnitsDoDelete" />
					|-include file="FiltersRedirectInclude.tpl" filters=$filters-|
					|-if isset($pager) && ($pager->getPage() gt 1)-|
					<input type="hidden" name="page" id="page" value="|-$pager->getPage()-|" />
					|-/if-|
