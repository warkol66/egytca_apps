...
|-/if-|</form></div></td>
			...
			<tr>
				 <th colspan="|-if $moduleConfig.useDependencies.value =="YES"-|9|-else-|8|-/if-|" class="thFillTitle"><div class="rightLink"><a href="Main.php?do=planningMinistryObjectivesEdit" class="addLink">Agregar Objetivo Ministerial</a></div></th>
			</tr>
			<tr class="thFillTitle">
			<th width="5%" class="thFillTitle">Id</th>
				<th width="25%">Objetivo Ministerial</th>
				<th width="4%">&nbsp;</th>
			</tr>
		</thead>
		<tbody>|-if $ministryObjectiveColl|@count eq 0-|
			<tr>
				 <td colspan="|-if $moduleConfig.useDependencies.value =="YES"-|9|-else-|8|-/if-|">|-if isset($filters)-|No hay Objetivo Ministerial que concuerden con la búsqueda|-else-|No hay Objetivo Ministerial disponibles|-/if-|</td>
			</tr>
			|-else-|
		...
		|-/if-|
			<tr>
				<th colspan="|-if $moduleConfig.useDependencies.value =="YES"-|9|-else-|8|-/if-|" class="thFillTitle">|-if $ministryObjectiveColl|@count gt 5-|<div class="rightLink"><a href="Main.php?do=planningMinistryObjectivesEdit" class="addLink">Agregar Objetivo Ministerial</a></div>|-/if-|</th>
			</tr>
		</tbody>
	</table>
</div>
