...
<!--		<tr>
			<td colspan="3" class="tdSearch"><a href="javascript:void(null);" onClick='switch_vis("divSearch");' class="tdTitSearch">Búsqueda de Unidades de Medida </a>
				...
				<form action='Main.php' method='get' style="display:inline;">
					...
					&nbsp;&nbsp;&nbsp;
						...
						<input type="hidden" name="do" value="planningMeasureUnitsList" />
						&nbsp;&nbsp;
						|-if $filters|@count gt 0-|
						<input type="button" value="Quitar Filtros" onclick="location.href='Main.php?do=planningMeasureUnitsList'"/>
						|-/if-|
					</p>
				</form>
				</div>
		...
		|-if "planningMeasureUnitsEdit"|security_has_access-|
		<tr>
			<th colspan="3" class="thFillTitle">
				<div class="rightLink">
					...
					<form id="addInput1" action="Main.php" method="POST" onsubmit="setStatus('working'); prepareAndSubmit(this); showInput('addLink1', 'addInput1'); setStatus('done'); return false;" style="display: none;">
						...
						<input type="hidden" name="do" value="planningMeasureUnitsDoEditX" />
		...
		<tbody id="planningMeasureUnitsTbody">
		|-if $planningMeasureUnitColl|@count eq 0-|
		<tr>
...
|-include file="PlanningMeasureUnitsListInclude.tpl"-|
...
function prepareAndSubmit(form) {
	...
	var myAjax = new Ajax.Updater(
		{ success: 'planningMeasureUnitsTbody' },
		'Main.php',
		{
			method: 'post',
			postBody: fields,
