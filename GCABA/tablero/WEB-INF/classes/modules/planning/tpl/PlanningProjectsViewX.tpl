...
|-assign var=activities value=$planningProject->getActivitiesOrderedForGantt()-|
	...
	|-capture name=task-|<tasks>|-foreach from=$activities item=activity name=for_contractActivitys-|<task start='|-$activity->getStartingDate()|date_format-|' end='|-$activity->getEndingDate()|date_format-|' label='|-$activity|escape:"javascript"-|' showLabel='0' id='|-$activity->getid()-|' showborder='0' color='|-if $activity->getAcomplished()-|00ACD3|-else-|D38200|-/if-|' |-if $activity->getPriority()-|showBorder='true' borderThickness='3' borderColor='FFF602'|-/if-|/>|-/foreach-|</tasks><milestones>|-foreach from=$activities item=activity name=for_contractActivitys-||-if ($activity->getStartingDate() eq $activity->getEndingDate()) || ($activity->getStartingDate() neq "" && $activity->getEndingDate() eq "")-|<milestone date='|-if $activity->getStartingDate() neq ""-||-$activity->getStartingDate()|date_format-||-else-||-$activity->getEndingDate()|date_format-||-/if-|' taskId='|-$activity->getid()-|' radius='10' color='333333' shape='Star' numSides='5' borderThickness='1' tooltext='|-$activity|escape:"javascript"-|, |-if $activity->getStartingDate() neq ""-||-$activity->getStartingDate()|date_format-||-else-||-$activity->getEndingDate()|date_format-||-/if-|'/>|-/if-||-/foreach-|</milestones></chart>|-/capture-| 
