  ...
  <form name="form_edit_objective" id="form_edit_objective" action="Main.php" method="post">
    ...
    <fieldset title="Formulario de edición de datos de un Objetivo Operativo">
     <legend>Ingrese los datos del Objetivo Operativo</legend>
      ...
      <input name="params[name]" type="text" id="params_name" size="80" value="|-$operativeObjective->getName()-|" title="Nombre del Objetivo Operativo" maxlength="255" /> 
      </p>
    <p> 
      <label for="params_description">Descripción</label>
      <textarea name="params[description]" cols="70" rows="6" wrap="VIRTUAL" id="params_description" type="text" title="Descripción del Objetivo Operativo" >|-$operativeObjective->getDescription()|escape-|</textarea> 
    </p> 
      <p>
        <label for="params_contextualFactors">Factores contextuales</label>
      <input name="params[contextualFactors]" type="text" id="params_contextualFactors" size="80" value="|-$operativeObjective->getContextualFactors()-|" title="Nombre del Objetivo Operativo" maxlength="255" /> 
      </p>
    <p>|-if !$operativeObjective->isNew()-|
