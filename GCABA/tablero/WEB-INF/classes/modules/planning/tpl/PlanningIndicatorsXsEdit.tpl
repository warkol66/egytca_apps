|-if !$disbursement-|<h2>Planificación</h2>
<h1>Administración de Indicadores - |-if $action eq "edit"-|Editar|-else-|Crear|-/if-| Variables</h1>
...
|-if $message eq "ok"-|
<div class="successMessage">Variables guardadas correctamente.</div>
|-elseif $message eq "error"-|
<div class="failureMessage">Ha ocurrido un error al intentar guardar las Variables.</div>
|-/if-|
<p><strong>Indicador:</strong> |-$indicator->getName()-|</p>
<p><strong>Tipo de Gráfico:</strong> |-$indicator->getIndicatorType()-|</p>|-else-|
<h2>Proyectos</h2>
	...
	<ul id="xsList">
		...
		|-foreach from=$xValues item=xValue name=for_xValue-|
			<li id="xsList_|-$xValue->getId()-|" class="contentLi">
				...
				<a href="#" onclick='if (confirm("¿Seguro que desea eliminar la variable?")){new Ajax.Updater("operationInfo", "Main.php?do=planningIndicatorsXsDoDeleteX", { method: "post", parameters: { id: "|-$xValue->getId()-|"}, evalScripts: true})};return false;'><img src="images/clear.png" class="icon iconDelete"></a>
			</li>
		|-/foreach-|
	</ul>
</div>
...
<script type="text/javascript">
   Sortable.create("xsList", {
		onUpdate: function() {  
				...
				new Ajax.Updater("operationInfo", "Main.php?do=planningIndicatorsXsDoOrderByIndicatorX",
					{
						method: "post",  
