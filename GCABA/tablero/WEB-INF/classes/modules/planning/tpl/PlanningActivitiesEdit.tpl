...
<!-- Link VOLVER -->
<!-- /Link VOLVER -->
<p class='paragraphEdit'>A continuación se puede modificar los elementos que definen la Obra.</p>
<div id="div_project"> 
...
|-else-|
	...
	<div class="errorMessage">El identificador de obra ingresado no es válido. Seleccione una obra de la lista.</div>
